...
export const metadata: Metadata = {
  title: 'Demolition Safety: What Homeowners Should Know | Demolition Pros',
  description: 'Demolition involves real risks. Here\'s what to expect and how professionals keep everyone safe.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Demolition Safety: What Homeowners Should Know"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Demolition Safety What Homeowners Should Know</h2>
