...
export const metadata: Metadata = {
  title: 'What Actually Happens During a Demolition Project? | Demolition Pros',
  description: 'Curious about the demolition process? Here\'s a step-by-step look at what goes into tearing down a structure.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/commercial-demolition.webp"
          alt="What Actually Happens During a Demolition Project?"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding What Happens During Demolition</h2>
