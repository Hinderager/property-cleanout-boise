...
export const metadata: Metadata = {
  title: 'How to Prepare Your Property for Demolition | Demolition Pros',
  description: 'A little prep work goes a long way. Here\'s what to handle before the demo crew arrives.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/interior-demolition.webp"
          alt="How to Prepare Your Property for Demolition"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Preparing Property For Demolition</h2>
