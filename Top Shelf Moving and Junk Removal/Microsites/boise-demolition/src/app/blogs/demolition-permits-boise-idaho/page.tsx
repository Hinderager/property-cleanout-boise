...
export const metadata: Metadata = {
  title: 'Do You Need a Demolition Permit in Boise? (Quick Answer) | Demolition Pros',
  description: 'The permit question trips up a lot of property owners. Here\'s what Boise requires for demolition projects.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Do You Need a Demolition Permit in Boise? (Quick Answer)"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Do You Need a Demolition Permit in Boise? (Quick Answer)
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Demolition Permits Boise Idaho</h2>
