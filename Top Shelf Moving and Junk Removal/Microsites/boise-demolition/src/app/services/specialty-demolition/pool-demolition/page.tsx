...
export const metadata: Metadata = {
  ...
  description: 'In-ground and above-ground pool demolition and removal. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/specialty-demolition/pool-demolition',
  },
}

export default function PoolDemolitionRemovalPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Pool Demolition & Removal</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">In-ground and above-ground pool demolition and removal.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>In-ground pools are expensive to maintain, and if you're not using it, it's just a liability. We demolish and remove pools—both in-ground and above-ground.</p>
              <p>In-ground pool removal involves breaking up the concrete, removing the shell, and backfilling the hole with clean fill. We can do partial or complete removal depending on your needs and budget.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your pool demolition & removal project.</p>
