...
export const metadata: Metadata = {
  ...
  description: 'In-ground and above-ground pool demolition and removal. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
