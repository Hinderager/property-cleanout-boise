...
export const metadata: Metadata = {
  title: 'Concrete Removal Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Concrete demolition, removal, and disposal services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/specialty-demolition/concrete-removal',
  },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Concrete Removal</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Concrete demolition, removal, and disposal services.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Old concrete driveways, patios, sidewalks, and pads all eventually need to be removed. We break it up, load it out, and haul it away.</p>
              <p>We use jackhammers for smaller jobs and heavy equipment for large concrete removal. The broken concrete can often be recycled as road base, which saves on disposal costs.</p>
            </div>
