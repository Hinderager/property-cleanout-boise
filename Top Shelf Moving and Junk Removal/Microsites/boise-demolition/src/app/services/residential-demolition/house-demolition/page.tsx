...
export const metadata: Metadata = {
  title: 'House Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Complete house demolition services including foundation removal and site cleanup. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/residential-demolition/house-demolition',
  },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">House Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Complete house demolition services including foundation removal and site cleanup.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We handle complete house demolition projects throughout the Treasure Valley. Whether you're tearing down to rebuild or clearing a lot, we'll get it done safely and efficiently.</p>
              <p>Our house demolition service includes everything from permit applications to final site cleanup. We know how to work around tight lots, protect neighboring properties, and handle the complications that come with residential demo work.</p>
            </div>
