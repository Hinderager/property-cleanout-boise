...
export const metadata: Metadata = {
  ...
  description: 'Complete house demolition services including foundation removal and site cleanup. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
