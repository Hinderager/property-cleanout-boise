...
export const metadata: Metadata = {
  title: 'Garage Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Professional garage demolition services for attached and detached garages. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/residential-demolition/garage-demolition',
  },
}

export default function GarageDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Garage Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional garage demolition services for attached and detached garages.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Old garages—whether attached or detached—eventually need to come down. We demo garages of all sizes, from small one-car structures to large multi-bay shops.</p>
              <p>We're careful to protect your house if it's an attached garage, and we'll coordinate utility disconnections if needed. The whole structure gets demolished, hauled away, and the site cleaned up.</p>
            </div>
