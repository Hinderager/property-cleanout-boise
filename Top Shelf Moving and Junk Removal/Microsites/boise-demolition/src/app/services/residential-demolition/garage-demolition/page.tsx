...
export const metadata: Metadata = {
  ...
  description: 'Professional garage demolition services for attached and detached garages. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
