...
export const metadata: Metadata = {
  title: 'Shed Removal & Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Fast, affordable shed removal and demolition services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/residential-demolition/shed-removal',
  },
}

export default function ShedRemovalDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Shed Removal & Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Fast, affordable shed removal and demolition services.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Got an old shed that needs to go? We'll tear it down and haul it away, usually in a matter of hours.</p>
              <p>Most shed removals are straightforward—we show up, knock it down, load it up, and clean up the area. If it's got a concrete pad you want removed too, we can handle that as well.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your shed removal & demolition project.</p>
