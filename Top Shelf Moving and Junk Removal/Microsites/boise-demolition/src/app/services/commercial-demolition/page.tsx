...
export const metadata: Metadata = {
  ...
  description: 'Professional commercial demolition services for businesses and properties across the Treasure Valley. Serving Boise, Meridian, Nampa & the Treasure Valley. Call (208) 505-9352.',
  alternates: {
