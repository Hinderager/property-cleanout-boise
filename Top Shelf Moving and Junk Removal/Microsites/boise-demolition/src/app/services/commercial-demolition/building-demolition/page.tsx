...
export const metadata: Metadata = {
  title: 'Commercial Building Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Complete commercial building demolition for retail, office, and industrial properties. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/commercial-demolition/building-demolition',
  },
}

export default function CommercialBuildingDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Commercial Building Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Complete commercial building demolition for retail, office, and industrial properties.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Commercial building demolition requires more planning, more permitting, and more coordination than residential work. We handle all of it.</p>
              <p>From small retail buildings to multi-story structures, we have the equipment and experience to demo it safely. We coordinate with environmental consultants, utility companies, and local authorities to make sure everything's done by the book.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your commercial building demolition project.</p>
