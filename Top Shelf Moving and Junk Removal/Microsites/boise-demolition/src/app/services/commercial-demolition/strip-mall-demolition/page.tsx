...
export const metadata: Metadata = {
  ...
  description: 'Strip mall and retail center demolition services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
