...
export const metadata: Metadata = {
  title: 'Strip Mall Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Strip mall and retail center demolition services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/commercial-demolition/strip-mall-demolition',
  },
}

export default function StripMallDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Strip Mall Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Strip mall and retail center demolition services.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Strip malls and retail centers present unique challenges—multiple tenants, shared utilities, occupied adjacent spaces. We know how to work around these complications.</p>
              <p>We'll coordinate phased demolition if needed, protect occupied units, and manage the logistics of removing a lot of material from sites with limited access.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your strip mall demolition project.</p>
