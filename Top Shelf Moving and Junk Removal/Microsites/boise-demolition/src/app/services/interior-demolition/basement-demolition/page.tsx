...
export default function BasementDemolitionPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Basement finishing projects often start with demoing old, outdated finishes. We remove old paneling, drop ceilings, carpet, and whatever else needs to go.</p>
              <p>We haul everything up and out—no small task when you're working in a basement. We also handle basement wall removal if you're reconfiguring the layout.</p>
            </div>
