...
export const metadata: Metadata = {
  title: 'Bathroom Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Bathroom gut-out and demolition services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/interior-demolition/bathroom-demolition',
  },
}

export default function BathroomDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Bathroom Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Bathroom gut-out and demolition services.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Bathroom demos require careful work around plumbing and water lines. We remove tubs, showers, toilets, vanities, tile, and drywall without damaging what stays.</p>
              <p>We cap off plumbing lines properly, contain dust and debris, and protect the rest of your house from demo mess. Most bathroom gut jobs take a day or less.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your bathroom demolition project.</p>
