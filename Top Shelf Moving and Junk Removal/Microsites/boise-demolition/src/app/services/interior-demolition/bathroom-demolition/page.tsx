...
export const metadata: Metadata = {
  ...
  description: 'Bathroom gut-out and demolition services. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
