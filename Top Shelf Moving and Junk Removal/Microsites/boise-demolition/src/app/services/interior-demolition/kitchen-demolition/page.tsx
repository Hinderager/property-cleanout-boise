...
export const metadata: Metadata = {
  title: 'Kitchen Demolition Boise & Treasure Valley | Boise Demolition Pros',
  description: 'Kitchen gut-out and demolition for remodeling projects. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/services/interior-demolition/kitchen-demolition',
  },
}

export default function KitchenDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Kitchen Demolition</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Kitchen gut-out and demolition for remodeling projects.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Kitchen remodels usually start with gutting the old kitchen. We remove cabinets, countertops, flooring, and drywall—whatever you need stripped out.</p>
              <p>We're careful not to damage plumbing lines, electrical wiring, or structural elements you're keeping. We can take it down to the studs or just remove specific elements, depending on your remodel plans.</p>
            </div>
            ...
            <div className="bg-blue-50 p-8 rounded-lg text-center">
              ...
              <p className="text-gray-600 mb-6">Call us for a free, no-obligation quote on your kitchen demolition project.</p>
