...
export const metadata: Metadata = {
  ...
  description: 'Kitchen gut-out and demolition for remodeling projects. Professional service in Boise, Meridian, Nampa & throughout the Treasure Valley. Call (208) 505-9352 for a free quote.',
  alternates: {
