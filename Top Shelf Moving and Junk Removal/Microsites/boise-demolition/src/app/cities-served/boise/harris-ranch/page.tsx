...
export const metadata: Metadata = {
  title: 'Demolition Harris Ranch Boise | Top Shelf',
  description: 'Demolition services in Harris Ranch, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['demolition Harris Ranch', 'demolition Harris Ranch Boise', 'Harris Ranch boise demolition'],
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/boise/harris-ranch',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Demolition in Harris Ranch
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for demolition in Harris Ranch? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Demolition in Harris Ranch, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Harris Ranch homeowners sometimes need demo work for remodeling projects or removing outdoor structures. We work within HOA guidelines and community standards.</p>
                <p>
