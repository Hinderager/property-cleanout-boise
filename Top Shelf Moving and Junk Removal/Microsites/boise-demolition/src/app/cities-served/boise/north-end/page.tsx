...
export const metadata: Metadata = {
  title: 'Demolition North End Boise | Top Shelf',
  description: 'Demolition services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['demolition North End', 'demolition North End Boise', 'North End boise demolition'],
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Demolition in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for demolition in North End? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Demolition in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>North End properties sometimes need interior demolition for renovations or selective exterior demo for additions. We work carefully around historic structures, following all city guidelines for properties in or near the Historic District.</p>
                <p>
