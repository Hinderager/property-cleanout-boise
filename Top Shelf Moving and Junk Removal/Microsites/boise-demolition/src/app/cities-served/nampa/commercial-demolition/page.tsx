...
export const metadata: Metadata = {
  title: 'Commercial Demolition Nampa, ID | Boise Demolition Pros',
  description: 'Commercial building demolition services in Nampa, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/commercial-demolition',
  },
}

export default function NampaCommercialDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Commercial Demolition in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Commercial building demolition services in Nampa, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We handle commercial demolition projects throughout Nampa. From small retail buildings to larger commercial structures, we have the equipment and expertise to get it done safely and efficiently, with all proper permits and environmental compliance.</p>
            </div>
