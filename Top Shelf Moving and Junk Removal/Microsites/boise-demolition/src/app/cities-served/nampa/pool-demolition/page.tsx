...
export const metadata: Metadata = {
  title: 'Pool Demolition Nampa, ID | Boise Demolition Pros',
  description: 'In-ground and above-ground pool removal in Nampa, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/pool-demolition',
  },
}

export default function NampaPoolDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Pool Demolition in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">In-ground and above-ground pool removal in Nampa, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Removing an unwanted pool from your Nampa property? We handle both in-ground and above-ground pool demolition. In-ground pool removal involves breaking up the concrete, removing the shell, and backfilling with clean fill.</p>
            </div>
