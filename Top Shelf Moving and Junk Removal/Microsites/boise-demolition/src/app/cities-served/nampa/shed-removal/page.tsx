...
export const metadata: Metadata = {
  title: 'Shed Removal Nampa, ID | Boise Demolition Pros',
  description: 'Fast, affordable shed removal and demolition in Nampa, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/shed-removal',
  },
}

export default function NampaShedRemovalPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Shed Removal in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Fast, affordable shed removal and demolition in Nampa, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Old sheds taking up space in your Nampa backyard? We'll tear it down and haul it away, usually in a matter of hours. Most shed removals are straightforward—we show up, knock it down, load it up, and clean up the area.</p>
            </div>
