...
export const metadata: Metadata = {
  title: 'Concrete Removal Nampa, ID | Boise Demolition Pros',
  description: 'Concrete demolition and removal services in Nampa, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/concrete-removal',
  },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Concrete Removal in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Concrete demolition and removal services in Nampa, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Old driveways, patios, and concrete pads all eventually need removal. We break up and remove concrete from Nampa properties efficiently. The broken concrete is often recycled as road base, which can save on disposal costs.</p>
            </div>
