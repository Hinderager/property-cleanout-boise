...
export const metadata: Metadata = {
  title: 'Demolition Midway Nampa | Top Shelf',
  description: 'Demolition services in Midway, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['demolition Midway', 'demolition Midway Nampa', 'Midway nampa demolition'],
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Demolition in Midway
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for demolition in Midway? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Demolition in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Demo work for Midway home renovations and property improvements. Clean, efficient work.</p>
                <p>
