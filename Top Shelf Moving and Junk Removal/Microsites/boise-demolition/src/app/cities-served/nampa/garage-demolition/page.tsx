...
export const metadata: Metadata = {
  ...
  description: 'Garage demolition for attached and detached garages in Nampa, Idaho. Licensed, insured, professional service. Call (208) 505-9352 for a free quote.',
  alternates: {
