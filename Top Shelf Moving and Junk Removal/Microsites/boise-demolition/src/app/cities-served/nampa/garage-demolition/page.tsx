...
export const metadata: Metadata = {
  title: 'Garage Demolition Nampa, ID | Boise Demolition Pros',
  description: 'Garage demolition for attached and detached garages in Nampa, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/nampa/garage-demolition',
  },
}

export default function NampaGarageDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Garage Demolition in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Garage demolition for attached and detached garages in Nampa, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Need a garage torn down in Nampa? We demo attached and detached garages throughout the area. We're careful to protect your house if it's an attached garage, and we coordinate utility disconnections if needed.</p>
            </div>
