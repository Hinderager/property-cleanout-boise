...
export const metadata: Metadata = {
  title: 'Deck Removal Star, ID | Boise Demolition Pros',
  description: 'Professional deck removal and demolition in Star, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/star/deck-removal',
  },
}

export default function StarDeckRemovalPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Deck Removal in Star</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Professional deck removal and demolition in Star, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Old, rotted decks are safety hazards. If your Star deck has reached the end of its life, we'll remove it safely and efficiently. We take out the entire structure including railings, stairs, and support posts, then haul away all the debris.</p>
            </div>
