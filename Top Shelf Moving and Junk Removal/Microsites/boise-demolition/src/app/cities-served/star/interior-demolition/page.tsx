...
export const metadata: Metadata = {
  title: 'Interior Demolition Star, ID | Boise Demolition Pros',
  description: 'Interior gut-out and demolition for remodels in Star, Idaho. Licensed, insured, professional service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-demolition.com/cities-served/star/interior-demolition',
  },
}

export default function StarInteriorDemolitionPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">Interior Demolition in Star</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto text-center mb-8">Interior gut-out and demolition for remodels in Star, Idaho</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Remodeling your Star home? We provide interior demolition services for kitchens, bathrooms, basements, and whole-house gut jobs. We're careful not to damage structural elements you're keeping, and we contain dust and debris to minimize impact on the rest of your house.</p>
            </div>
