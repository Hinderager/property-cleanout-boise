...
export default function CaldwellPoolDemolitionPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Removing an unwanted pool from your Caldwell property? We handle both in-ground and above-ground pool demolition. In-ground pool removal involves breaking up the concrete, removing the shell, and backfilling with clean fill.</p>
            </div>
