...
const services = [
        { name: 'House Demolition', href: '/cities-served/kuna/house-demolition', description: 'Complete house demolition and removal services' },
        { name: 'Garage Demolition', href: '/cities-served/kuna/garage-demolition', description: 'Garage demolition for attached and detached garages' },
        { name: 'Shed Removal', href: '/cities-served/kuna/shed-removal', description: 'Fast, affordable shed removal and demolition' },
        { name: 'Deck Removal', href: '/cities-served/kuna/deck-removal', description: 'Professional deck removal and demolition' },
        { name: 'Pool Demolition', href: '/cities-served/kuna/pool-demolition', description: 'In-ground and above-ground pool removal' },
        { name: 'Commercial Demolition', href: '/cities-served/kuna/commercial-demolition', description: 'Commercial building demolition services' },
        { name: 'Concrete Removal', href: '/cities-served/kuna/concrete-removal', description: 'Concrete demolition and removal services' },
        { name: 'Interior Demolition', href: '/cities-served/kuna/interior-demolition', description: 'Interior gut-out and demolition for remodels' },
]

export default function KunaDemolitionPage() {
  return (
      ...
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-[#FFC845] font-semibold">Serving Kuna, Idaho</span>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto mb-12">
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>Kuna and the surrounding area often have properties with outbuildings, shops, and agricultural structures. We demo all of it.</p>
            </div>
          </div>

          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-8 text-center">Our Kuna Demolition Services</h2>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6 text-center">Why Choose Us for Kuna Demolition?</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-white p-6 rounded-lg">
                <h3 className="text-xl font-bold text-dark-blue mb-2">Local & Experienced</h3>
                <p className="text-gray-600">We know Kuna and work throughout the area regularly. We understand local permit requirements and site conditions.</p>
              </div>
              <div className="bg-white p-6 rounded-lg">
