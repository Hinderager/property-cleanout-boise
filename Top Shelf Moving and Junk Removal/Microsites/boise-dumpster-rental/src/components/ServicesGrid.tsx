...
import { Package, Truck, Clock, Recycle } from 'lucide-react'
...
const services = [
  {
    icon: Package,
    title: '10 & 15 Yard',
    description: 'Perfect for small cleanouts, bathroom remodels, and garage cleanups. Fits in most driveways.',
  },
  {
    icon: Truck,
    title: '20 Yard',
    description: 'Our most popular size. Ideal for roofing projects, kitchen remodels, and medium construction jobs.',
  },
  {
    icon: Package,
    title: '30 Yard',
    description: 'Large construction projects, whole home cleanouts, and commercial jobs. Maximum capacity.',
  },
  {
    icon: Clock,
    title: 'Same Day Delivery',
    description: 'Need a dumpster today? We offer same-day delivery throughout the Treasure Valley.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Roll-off dumpster rental for residential and commercial projects in the Treasure Valley
          </p>
        </div>
