...
export const metadata: Metadata = {
  title: 'What Can (and Can\'t) Go in a Dumpster? | Dumpster Rental Pros',
  description: 'Some items are prohibited for good reason. Here\'s the complete list of what\'s allowed.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/construction-dumpster.webp"
          alt="What Can (and Can't) Go in a Dumpster?"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding What Can Go In A Dumpster</h2>
