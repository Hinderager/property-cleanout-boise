...
export const metadata: Metadata = {
  title: 'Dumpster Rental Costs in Boise: What to Expect | Dumpster Rental Pros',
  description: 'Prices vary based on size, duration, and what you\'re tossing. Here\'s a realistic breakdown.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/roll-off-dumpster.webp"
          alt="Dumpster Rental Costs in Boise: What to Expect"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Dumpster Rental Costs in Boise: What to Expect
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Dumpster Rental Cost Boise</h2>
