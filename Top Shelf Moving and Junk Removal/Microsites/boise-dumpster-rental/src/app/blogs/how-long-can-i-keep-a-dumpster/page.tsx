...
export const metadata: Metadata = {
  title: 'How Long Can You Keep a Rental Dumpster? | Dumpster Rental Pros',
  description: 'Rental periods vary, and going over can cost you. Here\'s what to know about timing your rental.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="How Long Can You Keep a Rental Dumpster?"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding How Long Can I Keep A Dumpster</h2>
