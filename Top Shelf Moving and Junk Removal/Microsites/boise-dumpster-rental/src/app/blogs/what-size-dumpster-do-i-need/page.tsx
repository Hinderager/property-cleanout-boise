...
export const metadata: Metadata = {
  title: 'What Size Dumpster Do I Need? (Simple Guide) | Dumpster Rental Pros',
  description: 'Choosing the wrong dumpster size is a common mistake. Here\'s how to get it right the first time.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="What Size Dumpster Do I Need? (Simple Guide)"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            What Size Dumpster Do I Need? (Simple Guide)
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding What Size Dumpster Do I Need</h2>
