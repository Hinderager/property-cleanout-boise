...
export const metadata: Metadata = {
  ...
  description: 'Rent a 40 yard dumpster in Boise - the biggest size for major commercial and construction projects. Call (208) 505-9352 for pricing.',
  alternates: { canonical: 'https://boisedumpsterrental.com/services/dumpster-sizes/40-yard' },
}
