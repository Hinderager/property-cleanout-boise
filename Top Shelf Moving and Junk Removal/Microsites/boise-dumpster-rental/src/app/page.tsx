...
import { Trash2, Phone, Clock, Truck } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gradient-to-br from-brand-dark via-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-8">
          Affordable roll-off dumpster rentals for Boise and the Treasure Valley
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <p className="text-slate-400 text-sm">Same or next-day delivery available</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Clock className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Flexible Rentals</h3>
            <p className="text-slate-400 text-sm">Daily, weekly, or project-based</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Phone className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Local Service</h3>
            <p className="text-slate-400 text-sm">Boise-based, family owned</p>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
          <p className="text-slate-300 mb-4">
            Need a dumpster now? Give us a call!
          </p>
          <a
            href="tel:+12089187378"
            className="inline-flex items-center gap-3 bg-brand-orange hover:bg-orange-600 text-white font-bold py-4 px-8 rounded-xl text-xl transition-all duration-200 shadow-lg shadow-orange-500/30 hover:shadow-orange-500/50 hover:scale-105"
          >
