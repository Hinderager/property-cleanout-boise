...
export const metadata: Metadata = {
  title: 'Dumpster Rental West Boise Boise | Top Shelf',
  description: 'Dumpster Rental services in West Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['dumpster rental West Boise', 'dumpster rental West Boise Boise', 'West Boise boise dumpster rental'],
  alternates: {
    canonical: 'https://boise-dumpster-rental.com/cities-served/boise/west-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Dumpster Rental in West Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            West Boise residents trust us for dumpster rental. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Dumpster Rental in West Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>West Boise home projects need dumpsters, and we deliver. Various sizes available for renovation, cleanout, or construction debris.</p>
                <p>
