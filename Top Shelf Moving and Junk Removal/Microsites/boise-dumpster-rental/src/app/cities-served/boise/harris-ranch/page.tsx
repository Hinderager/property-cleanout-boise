...
export const metadata: Metadata = {
  title: 'Dumpster Rental Harris Ranch Boise | Top Shelf',
  description: 'Dumpster Rental services in Harris Ranch, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['dumpster rental Harris Ranch', 'dumpster rental Harris Ranch Boise', 'Harris Ranch boise dumpster rental'],
  alternates: {
    canonical: 'https://boise-dumpster-rental.com/cities-served/boise/harris-ranch',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Dumpster Rental in Harris Ranch
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for dumpster rental in Harris Ranch? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Dumpster Rental in Harris Ranch, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Home projects in Harris Ranch often require dumpsters. We provide clean containers and respect HOA guidelines for placement and duration.</p>
                <p>
