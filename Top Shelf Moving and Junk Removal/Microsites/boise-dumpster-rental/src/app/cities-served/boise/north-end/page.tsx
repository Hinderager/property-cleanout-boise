...
export const metadata: Metadata = {
  title: 'Dumpster Rental North End Boise | Top Shelf',
  ...
  alternates: {
    canonical: 'https://boise-dumpster-rental.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Dumpster Rental in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need dumpster rental services in the North End area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Dumpster Rental in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Renovating your North End home? We provide dumpsters in sizes that work for properties with limited driveway space. We'll help you choose the right size and handle any permit requirements for street placement.</p>
                <p>
