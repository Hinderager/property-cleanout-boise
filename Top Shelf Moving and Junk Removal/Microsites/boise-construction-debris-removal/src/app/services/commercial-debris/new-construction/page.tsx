...
export const metadata: Metadata = {
  ...
  description: 'Professional ongoing debris removal for new construction sites in Boise and the Treasure Valley. Licensed, insured, and reliable. Call (208) 505-9352.',
