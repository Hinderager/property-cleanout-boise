    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Concrete & Masonry Removal</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Professional heavy concrete and masonry debris removal throughout the Treasure Valley.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Debris Removal specializes in heavy concrete and masonry debris removal. We handle the cleanup so you can focus on what matters - finishing your project on time and on budget.</p>
