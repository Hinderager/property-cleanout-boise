...
export const metadata: Metadata = {
  ...
  description: 'Professional complete cleanup after structural demolition in Boise and the Treasure Valley. Licensed, insured, and reliable. Call (208) 943-5231.',
