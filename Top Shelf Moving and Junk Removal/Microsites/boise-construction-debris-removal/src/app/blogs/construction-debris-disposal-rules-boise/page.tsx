...
export const metadata: Metadata = {
  title: 'Construction Debris Disposal Rules in Boise (What You Need to Know) | Construction Debris Removal Pros',
  description: 'Ada County has specific rules about construction waste. Here\'s how to stay compliant and avoid fines.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Construction Debris Disposal Rules in Boise (What You Need to Know)"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Construction Debris Disposal Rules in Boise (What You Need to Know)
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Construction Debris Disposal Rules Boise</h2>
