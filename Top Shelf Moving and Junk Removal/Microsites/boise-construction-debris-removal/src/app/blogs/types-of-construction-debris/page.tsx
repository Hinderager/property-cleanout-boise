...
export const metadata: Metadata = {
  title: 'Types of Construction Debris and How Each Is Handled | Construction Debris Removal Pros',
  description: 'From concrete to drywall, different materials require different disposal methods. Here\'s the breakdown.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/demolition-debris.webp"
          alt="Types of Construction Debris and How Each Is Handled"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Types Of Construction Debris</h2>
