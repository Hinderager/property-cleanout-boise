...
export const metadata: Metadata = {
  ...
  description: 'A surprising amount of construction debris can be recycled. Here\'s what can be diverted from the landfill.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/roofing-debris.webp"
          alt="Can Construction Materials Be Recycled in Idaho?"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Recycling Construction Materials Idaho</h2>
