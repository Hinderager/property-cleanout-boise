...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-construction-debris-removal.com/cities-served/meridian/ten-mile',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Construction Debris Removal in Ten Mile Area
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Ten Mile Area residents trust us for construction debris removal. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Construction Debris Removal in Ten Mile Area, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>New construction and renovation debris in Ten Mile gets hauled away fast. We keep your jobsite organized.</p>
                <p>
