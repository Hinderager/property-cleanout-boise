...
export const metadata: Metadata = {
  ...
  description: 'Professional construction debris removal in Meridian, Idaho. Residential and commercial cleanup. Same-day service available. Call (208) 505-9352.',
