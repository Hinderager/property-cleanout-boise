...
export const metadata: Metadata = {
  title: 'Concrete Removal Eagle ID | Top Shelf Debris Removal',
  description: 'Professional concrete and masonry debris removal in Eagle, Idaho. Licensed and insured. Call (208) 943-5231 for fast service.',
  keywords: ['concrete removal Eagle', 'debris removal Eagle', 'construction cleanup Eagle'],
  alternates: {
    canonical: 'https://boise-construction-debris-removal.com/cities-served/eagle/concrete-removal',
  },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Concrete Removal in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional concrete and masonry debris removal serving Eagle and surrounding areas.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Top Shelf Debris Removal provides concrete and masonry debris removal throughout Eagle. We handle the heavy lifting and proper disposal so you can focus on your project.</p>
