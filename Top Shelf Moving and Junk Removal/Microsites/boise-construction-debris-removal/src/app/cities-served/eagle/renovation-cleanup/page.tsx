...
export const metadata: Metadata = {
  title: 'Renovation Cleanup Eagle ID | Top Shelf Debris Removal',
  description: 'Professional cleanup services for home renovation projects in Eagle, Idaho. Licensed and insured. Call (208) 943-5231 for fast service.',
  keywords: ['renovation cleanup Eagle', 'debris removal Eagle', 'construction cleanup Eagle'],
  alternates: {
    canonical: 'https://boise-construction-debris-removal.com/cities-served/eagle/renovation-cleanup',
  },
}

export default function EagleRenovationCleanupPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Renovation Cleanup in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional cleanup services for home renovation projects serving Eagle and surrounding areas.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Top Shelf Debris Removal provides cleanup services for home renovation projects throughout Eagle. We handle the heavy lifting and proper disposal so you can focus on your project.</p>
