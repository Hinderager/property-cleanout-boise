...
export default function GardenCityRoofingDebrisPage() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Top Shelf Debris Removal provides roofing material and shingle removal throughout Garden City. We handle the heavy lifting and proper disposal so you can focus on your project.</p>
