...
export const metadata: Metadata = {
  ...
  description: 'Professional residential remodel and renovation debris removal in Mountain Home, Idaho. Licensed and insured. Call (208) 943-5231 for fast service.',
