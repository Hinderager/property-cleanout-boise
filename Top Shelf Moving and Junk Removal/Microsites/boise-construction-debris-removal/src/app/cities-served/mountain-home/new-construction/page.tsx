...
export const metadata: Metadata = {
  ...
  description: 'Professional job site cleanup for new construction projects in Mountain Home, Idaho. Licensed and insured. Call (208) 943-5231 for fast service.',
