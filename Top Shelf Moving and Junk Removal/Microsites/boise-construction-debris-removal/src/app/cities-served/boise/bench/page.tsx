...
export const metadata: Metadata = {
  title: 'Construction Debris Removal The Bench Boise | Top Shelf',
  description: 'Construction Debris Removal services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['construction debris removal The Bench', 'construction debris removal The Bench Boise', 'The Bench boise construction debris removal'],
  alternates: {
    canonical: 'https://boise-construction-debris-removal.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Construction Debris Removal in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need construction debris removal services in the The Bench area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Construction Debris Removal in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Whether you're flipping a Bench house or updating your forever home, we haul away the construction debris so you don't have to make multiple dump runs.</p>
                <p>
