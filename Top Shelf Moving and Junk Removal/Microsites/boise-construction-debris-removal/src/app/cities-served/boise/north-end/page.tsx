...
export const metadata: Metadata = {
  title: 'Construction Debris Removal North End Boise | Top Shelf',
  description: 'Construction Debris Removal services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['construction debris removal North End', 'construction debris removal North End Boise', 'North End boise construction debris removal'],
  alternates: {
    canonical: 'https://boise-construction-debris-removal.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Construction Debris Removal in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving North End with professional construction debris removal services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Construction Debris Removal in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>North End renovation projects generate plenty of debris from old plaster, hardwood flooring, and other materials. We haul away construction waste so you can focus on the renovation, not the cleanup.</p>
                <p>
