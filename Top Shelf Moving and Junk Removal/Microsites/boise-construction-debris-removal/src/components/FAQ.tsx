...
export const faqs = [
  ...
  },
  {
    ...
    answer: "We cover Boise, Meridian, Nampa, Caldwell, Eagle, Kuna, Star, and the rest of the Treasure Valley. If you\'re outside that area, call us anyway-we might be able to help. (208) 943-5231."
  },
  {
