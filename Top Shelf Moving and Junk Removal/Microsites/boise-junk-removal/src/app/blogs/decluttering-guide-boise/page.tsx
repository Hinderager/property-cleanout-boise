...
export const metadata: Metadata = {
  ...
  description: 'Finally tackling that clutter? Here\'s a practical room-by-room approach that actually works.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="The Boise Homeowner's Guide to Decluttering"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Decluttering Guide Boise</h2>
