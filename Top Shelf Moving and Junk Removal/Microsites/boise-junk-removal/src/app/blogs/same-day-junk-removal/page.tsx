...
export const metadata: Metadata = {
  ...
  description: 'Sometimes you can\'t wait. Here\'s how same-day junk removal works in the Treasure Valley.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/yard-waste.webp"
          alt="Same-Day Junk Removal in Boise: When You Need It Gone Now"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Same-Day Junk Removal in Boise: When You Need It Gone Now
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Same Day Junk Removal</h2>
