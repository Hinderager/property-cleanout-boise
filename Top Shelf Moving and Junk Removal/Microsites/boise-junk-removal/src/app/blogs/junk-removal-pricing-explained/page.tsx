...
export const metadata: Metadata = {
  title: 'Junk Removal Pricing: How It Works | Junk Removal Pros',
  description: 'Most people have no idea how junk removal is priced. Here\'s the straightforward explanation.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Junk Removal Pricing: How It Works"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Junk Removal Pricing: How It Works
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Junk Removal Pricing Explained</h2>
