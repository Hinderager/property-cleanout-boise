...
export const metadata: Metadata = {
  ...
  description: 'The short answer: almost everything. Here\'s the full list of items we can haul.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/basement-cleanout.webp"
          alt="What Will Junk Removal Companies Actually Take?"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding What Junk Removal Companies Take</h2>
