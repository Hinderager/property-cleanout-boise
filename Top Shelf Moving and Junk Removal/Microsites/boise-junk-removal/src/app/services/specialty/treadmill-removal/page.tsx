...
export default function TreadmillRemovalPage() {
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/treadmill-removal.webp" alt="Exercise Equipment Removal in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Exercise Equipment Removal</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Exercise Equipment Removal</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Treadmills, ellipticals, weight sets, and gym equipment removed.</p>
        </div>
      </section>
      <QuickQuoteBar />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Treadmills, ellipticals, weight sets, and gym equipment removed. We serve the entire Treasure Valley with fast, professional service.</p>
