    ...
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Office Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Desk, chairs, cubicles, old equipment—we clear out office spaces efficiently with minimal disruption.</p>
        </div>
      </section>
      <QuickQuoteBar />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Desk, chairs, cubicles, old equipment—we clear out office spaces efficiently with minimal disruption. We serve the entire Treasure Valley with fast, professional service.</p>
