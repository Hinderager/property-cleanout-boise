...
export const metadata: Metadata = {
  ...
  description: 'Large-scale removal of pallets, equipment, and materials from warehouse and industrial spaces. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 943-5231.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/warehouse-cleanout.webp" alt="Warehouse Cleanout in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Warehouse Cleanout</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Warehouse Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Large-scale removal of pallets, equipment, and materials from warehouse and industrial spaces.</p>
        </div>
      </section>
      <QuickQuoteBar />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Large-scale removal of pallets, equipment, and materials from warehouse and industrial spaces. We serve the entire Treasure Valley with fast, professional service.</p>
