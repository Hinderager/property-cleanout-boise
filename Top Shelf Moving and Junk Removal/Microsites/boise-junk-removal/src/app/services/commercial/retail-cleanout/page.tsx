...
export const metadata: Metadata = {
  title: 'Retail Store Cleanout Boise Idaho | Top Shelf Junk Removal',
  description: 'Fixtures, displays, inventory, and debris removed from retail locations. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/services/commercial/retail-cleanout' },
}
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/retail-cleanout.webp" alt="Retail Store Cleanout in Boise" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            <Link href="/services" className="hover:text-white">Services</Link>
            <span className="mx-2">/</span>
            <Link href="/services/commercial" className="hover:text-white">Commercial Junk Removal</Link>
            <span className="mx-2">/</span>
            <span className="text-white">Retail Store Cleanout</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Retail Store Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Fixtures, displays, inventory, and debris removed from retail locations.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Fixtures, displays, inventory, and debris removed from retail locations. We serve the entire Treasure Valley with fast, professional service.</p>
