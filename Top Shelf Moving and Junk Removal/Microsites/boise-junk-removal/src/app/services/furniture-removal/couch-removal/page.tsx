...
export const metadata: Metadata = {
  title: 'Couch & Sofa Removal Boise Idaho | Top Shelf Junk Removal',
  description: 'Couches, sectionals, loveseats, and recliners picked up and disposed of responsibly. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/services/furniture-removal/couch-removal' },
}
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/couch-removal.webp" alt="Couch & Sofa Removal in Boise" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            <Link href="/services" className="hover:text-white">Services</Link>
            <span className="mx-2">/</span>
            <Link href="/services/furniture-removal" className="hover:text-white">Furniture Removal</Link>
            <span className="mx-2">/</span>
            <span className="text-white">Couch & Sofa Removal</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Couch & Sofa Removal</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Couches, sectionals, loveseats, and recliners picked up and disposed of responsibly.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Couches, sectionals, loveseats, and recliners picked up and disposed of responsibly. We serve the entire Treasure Valley with fast, professional service.</p>
