...
export const metadata: Metadata = {
  ...
  description: 'Mattresses, box springs, and bed frames removed. We can handle any size. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 943-5231.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/mattress-removal.webp" alt="Mattress Removal in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Mattress Removal</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Mattress Removal</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Mattresses, box springs, and bed frames removed. We can handle any size.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Mattresses, box springs, and bed frames removed. We can handle any size. We serve the entire Treasure Valley with fast, professional service.</p>
