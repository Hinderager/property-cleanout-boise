...
export const metadata: Metadata = {
  ...
  description: 'Clear out years of accumulated items from your basement. Fast, thorough, and hassle-free. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/services/residential/basement-cleanout' },
}
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/basement-cleanout.webp" alt="Basement Cleanout in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Basement Cleanout</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Basement Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Clear out years of accumulated items from your basement. Fast, thorough, and hassle-free.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Clear out years of accumulated items from your basement. Fast, thorough, and hassle-free. We serve the entire Treasure Valley with fast, professional service.</p>
