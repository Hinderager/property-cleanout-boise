...
export const metadata: Metadata = {
  ...
  description: 'Complete junk removal services for homes throughout the Boise area. Serving Boise, Meridian, Nampa, and the Treasure Valley. Free estimates. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-junk-removal.com/services/residential' },
}
