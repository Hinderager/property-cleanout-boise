...
export const metadata: Metadata = {
  ...
  description: 'Empty that storage unit you have been paying for. We remove everything and sweep it clean. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-junk-removal.com/services/residential/storage-unit-cleanout' },
}
