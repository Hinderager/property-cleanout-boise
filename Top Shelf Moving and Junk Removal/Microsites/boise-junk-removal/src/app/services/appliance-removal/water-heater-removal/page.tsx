...
export const metadata: Metadata = {
  ...
  description: 'Tank and tankless water heaters properly disposed of. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/services/appliance-removal/water-heater-removal' },
}
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] md:h-[400px] flex items-center">
        <Image src="/generated/water-heater-removal.webp" alt="Water Heater Removal in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          <nav className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2">/</span>
            <span className="text-white">Water Heater Removal</span>
          </nav>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Water Heater Removal</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Tank and tankless water heaters properly disposed of.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Tank and tankless water heaters properly disposed of. We serve the entire Treasure Valley with fast, professional service.</p>
