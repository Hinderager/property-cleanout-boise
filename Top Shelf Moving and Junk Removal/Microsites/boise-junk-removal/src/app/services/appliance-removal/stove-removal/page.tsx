...
export const metadata: Metadata = {
  ...
  description: 'Electric and gas stoves, ovens, and ranges safely removed. Professional junk removal in Boise and the Treasure Valley. Free estimates. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-junk-removal.com/services/appliance-removal/stove-removal' },
}
