...
const services = [
  { name: 'Household Junk', href: '/cities-served/eagle/household-junk' },
  { name: 'Furniture Removal', href: '/cities-served/eagle/furniture-removal' },
  { name: 'Appliance Removal', href: '/cities-served/eagle/appliance-removal' },
  { name: 'Garage Cleanout', href: '/cities-served/eagle/garage-cleanout' },
  { name: 'Yard Waste', href: '/cities-served/eagle/yard-waste' },
  { name: 'Hot Tub Removal', href: '/cities-served/eagle/hot-tub-removal' },
  { name: 'Office Cleanout', href: '/cities-served/eagle/office-cleanout' },
  { name: 'Estate Cleanout', href: '/cities-served/eagle/estate-cleanout' },
]
  ...
  return (
    <main className="pt-24">
      <section className="relative h-[400px] flex items-center">
        <Image src="/generated/eagle-junk.webp" alt="Junk Removal in Eagle, Idaho" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Junk Removal in Eagle, Idaho</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-dark-blue mb-6">Eagle Junk Removal Services</h2>
          <div className="prose prose-lg text-gray-600 mb-8">
            <p>Need junk removed in Eagle? We're your local team. Whether it's an old couch, a garage full of stuff, or a whole house cleanout, we handle it all.</p>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Our Eagle Services</h3>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Eagle Areas We Serve</h3>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get a Free Quote in Eagle</h3>
