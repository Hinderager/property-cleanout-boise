...
export const metadata: Metadata = {
  ...
  description: 'Professional office cleanout in Boise, Idaho. Fast commercial junk removal for offices, retail, and warehouses. Call (208) 943-5231.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/office-cleanout.webp" alt="Office Cleanout in Boise" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Office Cleanout in Boise</h1>
        </div>
      </section>
      <QuickQuoteBar />
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Moving offices? Downsizing? Clearing out old equipment? We handle commercial junk removal in Boise fast and professionally.</p>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span>General office clutter and trash</span>
              </li>
            </ul>

            <h2 className="text-2xl font-bold text-dark-blue mt-8 mb-4">Why Businesses Choose Us</h2>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span>Flexible scheduling—we work when you need us</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span>Professional, uniformed crew</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span>Data destruction available for sensitive materials</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0" />
                <span>Donation and recycling whenever possible</span>
              </li>
            </ul>
          </div>

          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Need Office Cleanout in Boise?</h2>
