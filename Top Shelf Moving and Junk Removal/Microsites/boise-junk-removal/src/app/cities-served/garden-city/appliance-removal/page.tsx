...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://boisejunkremovalpros.com/cities-served/garden-city/appliance-removal' },
}

export default function GardenCityApplianceRemovalPage() {
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/appliance-removal.webp" alt="Appliance Removal in Garden City" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Appliance Removal in Garden City</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Looking for appliance removal in Garden City? We've got you covered. Fast service, fair prices, and a team that actually shows up on time.</p>
