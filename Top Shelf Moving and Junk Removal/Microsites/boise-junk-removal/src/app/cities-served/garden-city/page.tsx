...
export const metadata: Metadata = {
  ...
  description: 'Professional junk removal in Garden City, Idaho. Same-day service, upfront pricing, eco-friendly disposal. Serving Riverside, Chinden Boulevard, Glenwood Street and more. Call (208) 943-5231.',
...
const services = [
  { name: 'Household Junk', href: '/cities-served/garden-city/household-junk' },
  { name: 'Furniture Removal', href: '/cities-served/garden-city/furniture-removal' },
  { name: 'Appliance Removal', href: '/cities-served/garden-city/appliance-removal' },
  ...
  return (
    <main className="pt-24">
      <section className="relative h-[400px] flex items-center">
        <Image src="/generated/garden-city-junk.webp" alt="Junk Removal in Garden City, Idaho" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Junk Removal in Garden City, Idaho</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Fast, friendly junk removal for Garden City homes and businesses.</p>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-dark-blue mb-6">Garden City Junk Removal Services</h2>
          <div className="prose prose-lg text-gray-600 mb-8">
            <p>Need junk removed in Garden City? We're your local team. Whether it's an old couch, a garage full of stuff, or a whole house cleanout, we handle it all.</p>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Our Garden City Services</h3>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Garden City Areas We Serve</h3>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get a Free Quote in Garden City</h3>
