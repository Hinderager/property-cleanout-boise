...
export const metadata: Metadata = {
  ...
  description: 'Professional estate cleanout in Garden City, Idaho. Compassionate, respectful service for families. Full-house cleanouts. Call (208) 943-5231.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/estate-cleanout.webp" alt="Estate Cleanout in Garden City" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Estate Cleanout in Garden City</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            ...
            <p>We've helped families throughout Garden City through this process. We're here to take the burden off your shoulders so you can focus on what matters.</p>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Need Estate Cleanout Help in Garden City?</h2>
