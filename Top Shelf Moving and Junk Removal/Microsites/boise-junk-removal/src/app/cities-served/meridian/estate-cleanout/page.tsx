...
export const metadata: Metadata = {
  ...
  description: 'Professional estate cleanout in Meridian, Idaho. Compassionate, respectful service for families. Full-house cleanouts. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-junk-removal.com/cities-served/meridian/estate-cleanout' },
}
