...
const services = [
  { name: 'Household Junk', href: '/cities-served/nampa/household-junk' },
  { name: 'Furniture Removal', href: '/cities-served/nampa/furniture-removal' },
  { name: 'Appliance Removal', href: '/cities-served/nampa/appliance-removal' },
  { name: 'Garage Cleanout', href: '/cities-served/nampa/garage-cleanout' },
  { name: 'Yard Waste', href: '/cities-served/nampa/yard-waste' },
  { name: 'Hot Tub Removal', href: '/cities-served/nampa/hot-tub-removal' },
  { name: 'Office Cleanout', href: '/cities-served/nampa/office-cleanout' },
  { name: 'Estate Cleanout', href: '/cities-served/nampa/estate-cleanout' },
]
  ...
  return (
    <main className="pt-24">
      <section className="relative h-[400px] flex items-center">
        <Image src="/generated/nampa-junk.webp" alt="Junk Removal in Nampa, Idaho" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Junk Removal in Nampa, Idaho</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Fast, friendly junk removal for Nampa homes and businesses.</p>
        </div>
      </section>
      <QuickQuoteBar />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-dark-blue mb-6">Nampa Junk Removal Services</h2>
          <div className="prose prose-lg text-gray-600 mb-8">
            <p>Need junk removed in Nampa? We're your local team. Whether it's an old couch, a garage full of stuff, or a whole house cleanout, we handle it all.</p>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Our Nampa Services</h3>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Nampa Areas We Serve</h3>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get a Free Quote in Nampa</h3>
