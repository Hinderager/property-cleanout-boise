...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://boisejunkremovalpros.com/cities-served/nampa/office-cleanout' },
}

export default function NampaOfficeCleanoutPage() {
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/office-cleanout.webp" alt="Office Cleanout in Nampa" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Office Cleanout in Nampa</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Moving offices? Downsizing? Clearing out old equipment? We handle commercial junk removal in Nampa fast and professionally.</p>
