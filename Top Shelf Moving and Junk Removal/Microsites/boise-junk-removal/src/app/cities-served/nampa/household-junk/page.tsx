...
export const metadata: Metadata = {
  ...
  description: 'Professional household junk removal in Nampa, Idaho. Same-day service, upfront pricing. Call (208) 943-5231 for a free estimate.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/household-junk.webp" alt="Household Junk Removal in Nampa" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Household Junk Removal in Nampa</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Looking for household junk removal in Nampa? We've got you covered. Fast service, fair prices, and a team that actually shows up on time.</p>
