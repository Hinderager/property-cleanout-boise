...
export const metadata: Metadata = {
  title: 'Junk Removal Downtown Nampa Nampa | Top Shelf',
  ...
  alternates: {
    canonical: 'https://boise-junk-removal.com/cities-served/nampa/downtown-nampa',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Junk Removal in Downtown Nampa
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need junk removal services in the Downtown Nampa area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Junk Removal in Downtown Nampa, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Downtown Nampa's older buildings and homes often need serious cleanouts. We've helped property owners, landlords, and residents clear years worth of accumulated stuff from downtown properties.</p>
                <p>
