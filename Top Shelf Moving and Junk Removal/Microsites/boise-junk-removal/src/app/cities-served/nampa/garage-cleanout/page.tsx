...
export const metadata: Metadata = {
  ...
  description: 'Professional garage cleanout in Nampa, Idaho. Same-day service, upfront pricing. Call (208) 505-9352 for a free estimate.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/cities-served/nampa/garage-cleanout' },
}
