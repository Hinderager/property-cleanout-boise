...
export const metadata: Metadata = {
  ...
  description: 'Professional junk removal in Middleton, Idaho. Same-day service, upfront pricing, eco-friendly disposal. Serving Downtown Middleton, Purple Sage and more. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisejunkremovalpros.com/cities-served/middleton' },
}

const neighborhoods = ["Downtown Middleton","Purple Sage"]
const services = [
  { name: 'Household Junk', href: '/cities-served/middleton/household-junk' },
  { name: 'Furniture Removal', href: '/cities-served/middleton/furniture-removal' },
  { name: 'Appliance Removal', href: '/cities-served/middleton/appliance-removal' },
  ...
  return (
    <main className="pt-24">
      <section className="relative h-[400px] flex items-center">
        <Image src="/generated/middleton-junk.webp" alt="Junk Removal in Middleton, Idaho" fill className="object-cover" priority />
        <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/90 to-dark-blue/70" />
        <div className="relative z-10 container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Junk Removal in Middleton, Idaho</h1>
          <p className="text-xl text-gray-200 max-w-2xl">Fast, friendly junk removal for Middleton homes and businesses.</p>
        </div>
      </section>

      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-3xl font-bold text-dark-blue mb-6">Middleton Junk Removal Services</h2>
          <div className="prose prose-lg text-gray-600 mb-8">
            <p>Need junk removed in Middleton? We're your local team. Whether it's an old couch, a garage full of stuff, or a whole house cleanout, we handle it all.</p>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Our Middleton Services</h3>
          ...
          <h3 className="text-2xl font-bold text-dark-blue mb-4">Middleton Areas We Serve</h3>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h3 className="text-2xl font-bold text-white mb-4">Get a Free Quote in Middleton</h3>
