...
export const metadata: Metadata = {
  ...
  description: 'Professional office cleanout in Star, Idaho. Fast commercial junk removal for offices, retail, and warehouses. Call (208) 943-5231.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/office-cleanout.webp" alt="Office Cleanout in Star" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Office Cleanout in Star</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Moving offices? Downsizing? Clearing out old equipment? We handle commercial junk removal in Star fast and professionally.</p>
          ...
          <div className="bg-dark-blue rounded-xl p-8 text-center">
            <h2 className="text-2xl font-bold text-white mb-4">Need Office Cleanout in Star?</h2>
