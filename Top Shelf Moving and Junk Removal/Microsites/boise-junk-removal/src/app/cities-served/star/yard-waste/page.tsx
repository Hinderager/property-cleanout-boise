...
export const metadata: Metadata = {
  ...
  description: 'Professional yard waste removal in Star, Idaho. Same-day service, upfront pricing. Call (208) 943-5231 for a free estimate.',
  ...
  return (
    <main className="pt-24 pb-16">
      <section className="relative h-[300px] flex items-center">
        <Image src="/generated/yard-waste.webp" alt="Yard Waste Removal in Star" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white">Yard Waste Removal in Star</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg text-gray-600 mb-12">
            <p>Looking for yard waste removal in Star? We've got you covered. Fast service, fair prices, and a team that actually shows up on time.</p>
