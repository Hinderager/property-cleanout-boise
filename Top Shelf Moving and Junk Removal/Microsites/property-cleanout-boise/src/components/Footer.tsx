      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Rental Cleanout</li>
              <li className="text-white/80">Foreclosure Cleanout</li>
              <li className="text-white/80">Eviction Cleanout</li>
              <li className="text-white/80">REO Cleanout</li>
              <li className="text-white/80">Real Estate Cleanout</li>
              <li className="text-white/80">Investment Property</li>
            </ul>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">
                &copy; {new Date().getFullYear()} Boise Property Cleanout. All rights reserved.
              </p>
