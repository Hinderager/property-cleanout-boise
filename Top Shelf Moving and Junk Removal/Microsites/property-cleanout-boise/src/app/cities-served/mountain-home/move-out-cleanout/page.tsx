...
export default function MountainHomeMoveOutCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/move-out-cleanout.webp"
          alt="Move-Out Cleanout in Mountain Home, Idaho"
          fill
          priority
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Move-Out Cleanout Services in Mountain Home</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Dealing with a property cleanout situation in Mountain Home? We handle all types of move out cleanout projects throughout Mountain Home and the Treasure Valley.</p>
