...
export const metadata: Metadata = {
  title: 'Eviction Cleanout Star ID | Top Shelf Property Cleanout',
  description: 'Post-eviction property cleaning in Star, Idaho. Fast, professional service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['eviction cleanout Star', 'property cleanout Star'],
  alternates: {
    canonical: 'https://property-cleanout-boise.com/cities-served/star/eviction-cleanout',
  },
}
...
export default function StarEvictionCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/eviction-cleanout.webp"
          alt="Eviction Cleanout in Star, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Eviction Cleanout in Star</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Post-eviction property cleaning. Serving Star and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Eviction Cleanout Services in Star</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Dealing with a property cleanout situation in Star? We handle all types of eviction cleanout projects throughout Star and the Treasure Valley.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Eviction Cleanout in Star?</h3>
