...
export const metadata: Metadata = {
  ...
  description: 'Professional property cleanout services in Star, Idaho. Rental cleanouts, foreclosure cleanouts, estate cleanouts. Fast, reliable service. Call (208) 505-9352.',
