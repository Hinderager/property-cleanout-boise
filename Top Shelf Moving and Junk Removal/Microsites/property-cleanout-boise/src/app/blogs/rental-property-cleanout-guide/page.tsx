...
export const metadata: Metadata = {
  title: 'Rental Property Cleanout: A Landlord\'s Guide | Property Cleanout Pros',
  description: 'Tenant left a mess? Here\'s how to get your property ready for the next renter quickly.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Rental Property Cleanout: A Landlord's Guide"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Rental Property Cleanout Guide</h2>
