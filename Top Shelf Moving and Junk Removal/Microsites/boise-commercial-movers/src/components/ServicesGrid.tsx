...
import { Building2, Monitor, Package, Warehouse } from 'lucide-react'
...
const services = [
  {
    icon: Building2,
    title: 'Office Moving',
    description: 'Complete office relocation services. We move desks, chairs, cubicles, and common areas with minimal disruption.',
  },
  {
    icon: Monitor,
    title: 'IT Equipment',
    description: 'Safe handling of computers, servers, and sensitive electronics. Proper packing and secure transport.',
  },
  {
    icon: Package,
    title: 'Furniture Installation',
    description: 'Professional assembly and placement of office furniture. We set up workstations exactly how you need them.',
  },
  {
    icon: Warehouse,
    title: 'Warehouse Moves',
    description: 'Large-scale commercial and warehouse relocations. We handle inventory, shelving, and heavy equipment.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional commercial moving services for the Treasure Valley
          </p>
        </div>
