        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/office-moving-tips" className="text-white/80 hover:text-white transition-colors">
                  Office Moving Tips
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/moving-checklist" className="text-white/80 hover:text-white transition-colors">
                  Moving Checklist
                </Link>
              </li>
              <li>
                <Link href="/it-equipment-moving" className="text-white/80 hover:text-white transition-colors">
                  IT Equipment Moving
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Office Moving</li>
              <li className="text-white/80">Warehouse Relocation</li>
              <li className="text-white/80">IT Equipment Moving</li>
              <li className="text-white/80">Furniture Installation</li>
              <li className="text-white/80">Retail Store Moving</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a
                    href="mailto:info@boise-commercial-movers.com"
                    className="text-white/80 hover:text-white transition-colors"
                  >
                    info@boise-commercial-movers.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">
                &copy; {new Date().getFullYear()} Commercial Moving Pros. All rights reserved.
              </p>
