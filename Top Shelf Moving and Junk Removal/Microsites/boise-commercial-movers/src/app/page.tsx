...
import { Building2, Phone, Clock, Monitor } from 'lucide-react'
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <h3 className="text-white font-semibold mb-1">Minimal Downtime</h3>
            <p className="text-slate-400 text-sm">Keep your business running</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Building2 className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Furniture Setup</h3>
            <p className="text-slate-400 text-sm">Complete office installation</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Monitor className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">IT Equipment</h3>
            <p className="text-slate-400 text-sm">Safe tech handling</p>
          </div>
        </div>
