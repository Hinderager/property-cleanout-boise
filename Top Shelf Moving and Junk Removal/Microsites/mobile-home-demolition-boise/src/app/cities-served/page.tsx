...
export const metadata: Metadata = {
  ...
  description: 'We provide mobile home demolition services throughout the Treasure Valley including Boise, Meridian, Nampa, Caldwell, and surrounding areas. Call (208) 943-5231.',
