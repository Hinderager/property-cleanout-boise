...
export const metadata: Metadata = {
  ...
  description: 'Professional mobile home demolition services in Star. Licensed, insured, and serving a charming small town. Free quotes. Call (208) 943-5231.',
  alternates: { canonical: 'https://mobile-home-demolition-boise.com/cities-served/star' },
}
