...
export const metadata: Metadata = {
  ...
  description: 'Manufactured and modular home demolition in Star. Licensed professionals serving a charming small town. Call (208) 943-5231.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Manufactured Home Removal in Star</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>We provide professional manufactured home removal services in Star. Our licensed and insured team handles every aspect of your project efficiently and safely.</p>
