...
export const metadata: Metadata = {
  ...
  description: 'Old trailer demolition and disposal in Garden City. Licensed professionals serving a vibrant community along the Boise River. Call (208) 943-5231.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Trailer Removal in Garden City</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>We provide professional trailer removal services in Garden City. Our licensed and insured team handles every aspect of your project efficiently and safely.</p>
