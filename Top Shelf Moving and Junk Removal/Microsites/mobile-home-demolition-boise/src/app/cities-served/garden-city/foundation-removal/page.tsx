...
export const metadata: Metadata = {
  ...
  description: 'Concrete foundation and pier removal in Garden City. Licensed professionals serving a vibrant community along the Boise River. Call (208) 505-9352.',
  alternates: { canonical: 'https://boise-mobile-home-demolition.com/cities-served/garden-city/foundation-removal' },
}
