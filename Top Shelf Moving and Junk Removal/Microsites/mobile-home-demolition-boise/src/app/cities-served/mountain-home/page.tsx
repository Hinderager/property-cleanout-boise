...
export const metadata: Metadata = {
  ...
  description: 'Professional mobile home demolition services in Mountain Home. Licensed, insured, and serving serving the Mountain Home area. Free quotes. Call (208) 943-5231.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Mobile Home Demolition in Mountain Home</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Professional demolition services serving serving the Mountain Home area</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We provide complete mobile home demolition services in Mountain Home. Whether you're clearing land for new construction or removing an old mobile home, we handle everything from permits to final cleanup.</p>
            </div>
            <h2 className="text-3xl font-bold text-dark-blue mb-8 text-center">Our Mountain Home Services</h2>
