...
export const metadata: Metadata = {
  ...
  description: 'Professional mobile home demolition services in Nampa. Licensed, insured, and serving Canyon County largest city. Free quotes. Call (208) 943-5231.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We provide complete mobile home demolition services in Nampa. Whether you're clearing land for new construction or removing an old mobile home, we handle everything from permits to final cleanup.</p>
            </div>
            <h2 className="text-3xl font-bold text-dark-blue mb-8 text-center">Our Nampa Services</h2>
