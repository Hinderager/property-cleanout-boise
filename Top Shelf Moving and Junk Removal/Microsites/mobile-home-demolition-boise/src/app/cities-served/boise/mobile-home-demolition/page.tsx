...
export const metadata: Metadata = {
  ...
  description: 'Complete mobile home demolition and removal in Boise. Licensed professionals serving the heart of the Treasure Valley. Call (208) 943-5231.',
  alternates: { canonical: 'https://mobile-home-demolition-boise.com/cities-served/boise/mobile-home-demolition' },
}
