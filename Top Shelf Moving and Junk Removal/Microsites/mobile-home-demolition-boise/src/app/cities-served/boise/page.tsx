...
export const metadata: Metadata = {
  ...
  description: 'Professional mobile home demolition services in Boise. Licensed, insured, and serving the heart of the Treasure Valley. Free quotes. Call (208) 505-9352.',
  alternates: { canonical: 'https://boise-mobile-home-demolition.com/cities-served/boise' },
}

const services = [
  {
    "name": "Mobile Home Demolition",
    "href": "/cities-served/boise/mobile-home-demolition",
    "description": "Complete mobile home demolition and removal"
  },
  {
    "name": "Single-Wide Removal",
    "href": "/cities-served/boise/single-wide-removal",
    "description": "Single-wide mobile home demolition"
  },
  {
    "name": "Double-Wide Demolition",
    "href": "/cities-served/boise/double-wide-demolition",
    "description": "Double-wide mobile home removal"
  },
  {
    "name": "Manufactured Home Removal",
    "href": "/cities-served/boise/manufactured-home-removal",
    "description": "Manufactured and modular home demolition"
  },
  {
    "name": "Foundation Removal",
    "href": "/cities-served/boise/foundation-removal",
    "description": "Concrete foundation and pier removal"
  },
  {
    "name": "Site Clearing",
    "href": "/cities-served/boise/site-clearing",
    "description": "Complete site clearing and grading"
  },
  {
    "name": "Trailer Removal",
    "href": "/cities-served/boise/trailer-removal",
    "description": "Old trailer demolition and disposal"
  },
  {
    "name": "RV Removal",
    "href": "/cities-served/boise/rv-removal",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>We provide complete mobile home demolition services in Boise. Whether you're clearing land for new construction or removing an old mobile home, we handle everything from permits to final cleanup.</p>
            </div>
            <h2 className="text-3xl font-bold text-dark-blue mb-8 text-center">Our Boise Services</h2>
