...
export const metadata: Metadata = {
  ...
  description: 'Professional mobile home demolition services in Boise. Licensed, insured, and serving the heart of the Treasure Valley. Free quotes. Call (208) 943-5231.',
  alternates: { canonical: 'https://mobile-home-demolition-boise.com/cities-served/boise' },
}
