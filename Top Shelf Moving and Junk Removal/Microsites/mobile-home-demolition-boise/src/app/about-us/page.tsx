    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Boise Mobile Home Demolition</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Boise Mobile Home Demolition is a locally owned and operated demolition company serving property owners throughout the Treasure Valley. We specialize in safe, efficient removal of mobile homes, manufactured homes, and trailers of all sizes.</p>
              <p>Our team of experienced professionals handles everything from utility disconnection to foundation removal to final site cleanup. We're licensed, insured, and committed to doing the job right while keeping costs fair.</p>
              <p>Whether you're clearing land for new construction, removing an old mobile home, or cleaning up a property, we make the process simple and stress-free.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center">
                ...
                <p className="text-gray-600">Fully licensed demolition contractors with comprehensive liability coverage.</p>
              </div>
              <div className="text-center">
                <Shield className="w-12 h-12 text-[#FFC845] mx-auto mb-4" />
                <h3 className="text-xl font-bold text-dark-blue mb-2">Safe & Compliant</h3>
                <p className="text-gray-600">We follow all local codes and environmental regulations.</p>
              </div>
              <div className="text-center">
