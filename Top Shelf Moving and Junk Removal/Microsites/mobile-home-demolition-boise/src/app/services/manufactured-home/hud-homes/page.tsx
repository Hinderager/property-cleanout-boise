...
export const metadata: Metadata = {
  ...
  description: 'Removal of HUD-certified manufactured homes. Licensed, insured professionals serving the Treasure Valley. Call (208) 943-5231 for a free quote.',
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">HUD Home Removal</h1>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>We provide professional hud home removal services throughout the Treasure Valley. Our licensed and insured team handles every aspect of the job, from permits to final cleanup.</p>
