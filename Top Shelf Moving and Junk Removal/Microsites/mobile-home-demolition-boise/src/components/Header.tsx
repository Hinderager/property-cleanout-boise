...
const serviceCategories = [
  {
    ...
    href: '/services/mobile-home-demolition',
    services: [
      { name: 'Single Wide Demolition', href: '/services/mobile-home-demolition/single-wide' },
      { name: 'Double Wide Demolition', href: '/services/mobile-home-demolition/double-wide' },
      { name: 'Triple Wide Demolition', href: '/services/mobile-home-demolition/triple-wide' },
    ]
  },
  {
    name: 'Manufactured Homes',
    href: '/services/manufactured-home',
    services: [
      { name: 'HUD Homes', href: '/services/manufactured-home/hud-homes' },
      { name: 'Modular Homes', href: '/services/manufactured-home/modular-homes' },
    ]
  },
  {
    name: 'Site Services',
    ...
    services: [
      { name: 'Foundation Removal', href: '/services/site-services/foundation-removal' },
      { name: 'Site Grading', href: '/services/site-services/site-grading' },
      { name: 'Utility Disconnect', href: '/services/site-services/utility-disconnect' },
    ]
  },
  {
    ...
    services: [
      { name: 'RV Removal', href: '/services/additional/rv-removal' },
      { name: 'Shed Demolition', href: '/services/additional/shed-demolition' },
      { name: 'Trailer Removal', href: '/services/additional/trailer-removal' },
    ]
  },
]
        ...
        <div className="bg-[#10477d] lg:rounded-lg border-b-2 lg:border-2 border-[#1e3a5f] shadow-xl px-2 sm:px-4 md:px-6 lg:px-8 flex items-center h-14 lg:h-20">
          ...
          <Link href="/" className="flex items-center lg:flex-1 flex-1 justify-start">
            <span className="text-lg sm:text-xl lg:text-2xl font-bold text-white">
              <span className="text-[#FFC845]">Boise</span> Mobile Home Demolition
            </span>
          </Link>
