...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://boise-hoarding-cleanup.com/blogs/5-signs-loved-one-needs-hoarding-help',
  },
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/blogs/5-signs-loved-one-needs-hoarding-help',
  },
}
