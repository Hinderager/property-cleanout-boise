...
export const metadata: Metadata = {
  ...
  description: 'You want to help, but pushing too hard backfires. Here\'s a compassionate approach.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/compassionate-cleanup.webp"
          alt="How to Help a Family Member Who Hoards"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Helping Hoarder Family Member</h2>
