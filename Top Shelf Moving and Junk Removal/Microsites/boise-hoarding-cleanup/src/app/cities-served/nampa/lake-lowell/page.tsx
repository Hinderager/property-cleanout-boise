...
export const metadata: Metadata = {
  title: 'Hoarding Cleanup Lake Lowell Nampa | Top Shelf',
  description: 'Hoarding Cleanup services in Lake Lowell, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hoarding cleanup Lake Lowell', 'hoarding cleanup Lake Lowell Nampa', 'Lake Lowell nampa hoarding cleanup'],
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/nampa/lake-lowell',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Lake Lowell
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Lake Lowell with professional hoarding cleanup services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Lake Lowell, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Rural properties near Lake Lowell can hide significant hoarding situations. We've helped families throughout the area address these challenges.</p>
                <p>
