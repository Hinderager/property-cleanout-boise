...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/nampa/midway',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Midway
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Midway with professional hoarding cleanup services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Midway, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Even new communities like those in Midway can develop hoarding situations. We provide discreet cleanup services for Midway families.</p>
                <p>
