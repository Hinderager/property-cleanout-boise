...
export const metadata: Metadata = {
  title: 'Hoarding Cleanup Karcher Nampa | Top Shelf',
  description: 'Hoarding Cleanup services in Karcher, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hoarding cleanup Karcher', 'hoarding cleanup Karcher Nampa', 'Karcher nampa hoarding cleanup'],
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/nampa/karcher',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Karcher
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Karcher residents trust us for hoarding cleanup. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Karcher, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Karcher area families dealing with hoarding can count on us for discreet, professional help. We've worked throughout the area.</p>
                <p>
