...
export const metadata: Metadata = {
  title: 'Hoarding Cleanup The Bench Boise | Top Shelf',
  description: 'Hoarding Cleanup services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hoarding cleanup The Bench', 'hoarding cleanup The Bench Boise', 'The Bench boise hoarding cleanup'],
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving The Bench with professional hoarding cleanup services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>We've worked with Bench families dealing with hoarding situations in homes of all sizes. The neighborhood's mid-century homes often have plenty of storage space where items can accumulate over time. We approach every situation with compassion and discretion.</p>
                <p>
