...
export const metadata: Metadata = {
  title: 'Hoarding Cleanup Southeast Boise Boise | Top Shelf',
  description: 'Hoarding Cleanup services in Southeast Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hoarding cleanup Southeast Boise', 'hoarding cleanup Southeast Boise Boise', 'Southeast Boise boise hoarding cleanup'],
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Southeast Boise with professional hoarding cleanup services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>We've worked with Southeast Boise families dealing with hoarding in homes of all types. Whether it's a riverside property or a home near Table Rock, we approach each situation with care and respect.</p>
                <p>
