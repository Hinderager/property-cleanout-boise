...
export const metadata: Metadata = {
  ...
  description: 'Professional hoarding cleanup services in Eagle, Idaho. Discreet, compassionate hoarder cleanout for Eagle residents. Estate cleanout and clutter removal. Licensed & insured. Call (208) 505-9352.',
  keywords: [
