...
export const metadata: Metadata = {
  ...
  description: 'Professional hoarding cleanup services in Garden City, Idaho. Compassionate hoarder cleanout and clutter removal. Licensed & insured. Same-day service available. Call (208) 943-5231.',
  keywords: [
