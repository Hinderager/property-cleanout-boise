...
export const metadata: Metadata = {
  title: 'Hoarding Cleanup Lochsa Falls Meridian | Top Shelf',
  description: 'Hoarding Cleanup services in Lochsa Falls, Meridian, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hoarding cleanup Lochsa Falls', 'hoarding cleanup Lochsa Falls Meridian', 'Lochsa Falls meridian hoarding cleanup'],
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/meridian/lochsa-falls',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Lochsa Falls
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need hoarding cleanup services in the Lochsa Falls area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Lochsa Falls, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>When Lochsa Falls families need hoarding cleanup assistance, we provide discreet, respectful service. Our unmarked trucks and professional approach protect your privacy.</p>
                <p>
