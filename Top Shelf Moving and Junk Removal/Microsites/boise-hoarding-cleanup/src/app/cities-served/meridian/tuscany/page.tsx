...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-hoarding-cleanup.com/cities-served/meridian/tuscany',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-gunmetal">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hoarding Cleanup in Tuscany
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Tuscany residents trust us for hoarding cleanup. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-gunmetal mb-4">
                Hoarding Cleanup in Tuscany, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>When Tuscany families need hoarding cleanup, we provide the discrete, professional service this community expects. Your privacy is protected.</p>
                <p>
