...
export const metadata: Metadata = {
  ...
  description: 'Professional hoarding cleanup services in Kuna, Idaho. Compassionate hoarder cleanout and clutter removal. Licensed & insured. Same-day service available. Call (208) 505-9352.',
  keywords: [
