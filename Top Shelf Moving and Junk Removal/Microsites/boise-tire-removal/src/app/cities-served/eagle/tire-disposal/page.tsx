...
export const metadata: Metadata = {
  ...
  description: 'Professional tire disposal services in Eagle, Idaho. Fast, reliable tire removal. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisetireremoval.com/cities-served/eagle/tire-disposal' },
}
