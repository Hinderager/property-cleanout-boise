...
export const metadata: Metadata = {
  ...
  description: 'Professional bulk tire removal services in Eagle, Idaho. Fast, reliable tire removal. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisetireremoval.com/cities-served/eagle/bulk-tire-removal' },
}
