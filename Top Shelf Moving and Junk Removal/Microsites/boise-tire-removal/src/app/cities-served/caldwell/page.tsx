...
export const metadata: Metadata = {
  ...
  description: 'Professional tire removal and disposal services in Caldwell, Idaho. Residential, commercial, and agricultural tire pickup. Call (208) 505-9352.',
  alternates: { canonical: 'https://boisetireremoval.com/cities-served/caldwell' },
}
