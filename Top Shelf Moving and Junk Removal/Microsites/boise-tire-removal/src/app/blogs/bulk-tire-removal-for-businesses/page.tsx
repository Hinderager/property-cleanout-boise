...
export const metadata: Metadata = {
  ...
  description: 'Got a lot of tires to get rid of? Here\'s how bulk tire removal works for commercial clients.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/farm-tires.webp"
          alt="Bulk Tire Removal for Businesses and Farms"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Bulk Tire Removal For Businesses</h2>
