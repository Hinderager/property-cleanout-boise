...
export const metadata: Metadata = {
  ...
  description: 'Dumping tires illegally isn\'t worth the risk. Here\'s what you\'re facing if caught.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/commercial-tires.webp"
          alt="Illegal Tire Dumping in Idaho: Fines and Consequences"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Illegal Tire Dumping in Idaho: Fines and Consequences
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Illegal Tire Dumping Penalties</h2>
