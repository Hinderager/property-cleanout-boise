...
export const metadata: Metadata = {
  ...
  description: 'Old tires get a second life in surprising ways. Here\'s what happens after pickup.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/tire-pile.webp"
          alt="How Tire Recycling Works in Idaho"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Tire Recycling Idaho</h2>
