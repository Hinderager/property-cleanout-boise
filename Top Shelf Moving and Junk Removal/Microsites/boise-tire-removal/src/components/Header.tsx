...
const serviceCategories = [
  {
    ...
    services: [
      { name: 'Backyard Tire Removal', href: '/services/residential/backyard-tires' },
      { name: 'Garage Tire Removal', href: '/services/residential/garage-tires' },
      { name: 'Property Cleanup', href: '/services/residential/property-cleanup' },
    ]
  },
  {
    ...
    services: [
      { name: 'Auto Shop Tire Removal', href: '/services/commercial/auto-shops' },
      { name: 'Dealership Services', href: '/services/commercial/dealerships' },
      { name: 'Fleet Vehicle Tires', href: '/services/commercial/fleet-vehicles' },
    ]
  },
  {
    ...
    services: [
      { name: 'Farm Tire Removal', href: '/services/agricultural/farm-tires' },
      { name: 'Tractor Tire Removal', href: '/services/agricultural/tractor-tires' },
      { name: 'Equipment Tire Removal', href: '/services/agricultural/equipment-tires' },
    ]
  },
  {
    ...
    services: [
      { name: 'Tire Pile Removal', href: '/services/bulk-removal/tire-piles' },
      { name: 'Property Clearing', href: '/services/bulk-removal/property-clearing' },
      { name: 'Illegal Dump Cleanup', href: '/services/bulk-removal/illegal-dumps' },
    ]
  },
]
...
const resources = [
  { name: 'Tire Recycling Info', href: '/tire-recycling' },
  { name: 'Bulk Tire Pickup', href: '/bulk-pickup' },
  { name: 'Commercial Service', href: '/commercial' },
        ...
        <div className="bg-[#10477d] lg:rounded-lg border-b-2 lg:border-2 border-[#1e3a5f] shadow-xl px-2 sm:px-4 md:px-6 lg:px-8 flex items-center h-14 lg:h-20">
          ...
          <Link href="/" className="flex items-center lg:flex-1 flex-1 justify-start">
            <span className="text-lg sm:text-xl lg:text-2xl font-bold text-white">
              <span className="text-[#FFC845]">Boise</span> Tire Removal
            </span>
          </Link>
