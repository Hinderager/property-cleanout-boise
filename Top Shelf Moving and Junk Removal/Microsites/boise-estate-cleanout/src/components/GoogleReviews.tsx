...
// Static reviews for estate cleanout
const staticReviews = [
  {
    author: 'Margaret P.',
    relative_time: '2 weeks ago',
    rating: 5,
    text: 'After my mother passed, I was overwhelmed with cleaning out her home of 45 years. These folks were so compassionate and respectful. They helped us sort through everything, set aside family photos and heirlooms, and donated the rest. Made an incredibly difficult time much easier.',
  },
  {
    author: 'David R.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'We inherited a property from my uncle and needed to clear it out for sale. The team was professional and efficient. They found some valuable items we would have missed and coordinated donations with local charities. The house was spotless when they finished.',
  },
  {
    author: 'Jennifer K.',
    relative_time: '3 weeks ago',
    rating: 5,
    text: 'Working with the probate attorney to settle my father\'s estate was stressful enough. These guys made the cleanout portion so easy. They provided all the documentation we needed and worked around our timeline. Highly recommend for anyone dealing with estate settlement.',
  },
  {
    author: 'Michael T.',
    relative_time: '2 weeks ago',
    rating: 5,
    text: 'Had to clear out my grandmother\'s condo quickly for the new buyers. Called on Monday, they came Tuesday morning, and everything was done by Wednesday afternoon. Fair price, hard workers, and they were so respectful of grandma\'s belongings.',
  },
  {
    author: 'Lisa H.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'The attention to detail was impressive. They didn\'t just throw everything away—they sorted items into keep, donate, and dispose piles. Found my dad\'s military medals mixed in with some old boxes. Can\'t thank them enough for that.',
  },
  {
    author: 'Robert B.',
    relative_time: '3 months ago',
    rating: 5,
    text: 'Dealt with three different estate cleanout companies before finding these guys. They were the only ones who treated the job with the respect it deserved. My late wife\'s things went to people who needed them, not the dump. That matters to me.',
  },
  {
    author: 'Amanda C.',
    relative_time: '2 months ago',
    rating: 5,
    text: 'Estate sale company took what they wanted and left us with a mess. This team came in and cleared everything else professionally. They even swept and mopped the floors when they were done. Property was ready to list that same week.',
  },
  {
    author: 'James W.',
    relative_time: '1 week ago',
    rating: 5,
    text: 'Needed to clear out my in-laws\' home across town while managing everything from Boise. They communicated every step of the way with photos and updates. Couldn\'t have done it without them. Worth every penny.',
  },
]
