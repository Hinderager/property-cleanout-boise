...
import { Home, Briefcase, Heart, Truck } from 'lucide-react'
...
const services = [
  {
    ...
    description: 'Complete property clearing for inherited homes, estates, and family properties. We handle everything from furniture to personal items.',
  },
  {
    icon: Briefcase,
    title: 'Probate Services',
    description: 'Specialized cleanout services for probate properties. We work with attorneys, executors, and families during difficult transitions.',
  },
  {
    icon: Heart,
    title: 'Donation Coordination',
    description: 'We sort, organize, and coordinate donations to local charities. Your loved one\'s belongings find new homes where they\'re needed.',
  },
  {
    icon: Truck,
    title: 'Property Preparation',
    description: 'Getting a property ready for sale or rent? We clear out everything and prepare the space for staging, showing, or new occupants.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional estate cleanout services for the Treasure Valley
          </p>
        </div>
