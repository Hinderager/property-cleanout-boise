...
export const metadata: Metadata = {
  title: 'Senior Moving | Senior Services | Boise',
  description: 'Gentle moving services for older adults. Professional, compassionate service in the Treasure Valley. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-estate-cleanout.com/services/senior-services/senior-moving' },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Senior Moving</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Gentle moving services for older adults throughout the Treasure Valley.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides senior moving services with compassion, professionalism, and respect. We understand this is more than just clearing out a space—it's about handling memories, making tough decisions, and moving forward during a difficult time.</p>
            </div>
