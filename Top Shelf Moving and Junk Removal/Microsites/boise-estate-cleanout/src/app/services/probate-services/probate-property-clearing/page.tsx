...
export const metadata: Metadata = {
  ...
  description: 'Fast clearing to meet legal deadlines. Professional, compassionate service in the Treasure Valley. Call (208) 943-5231.',
  alternates: { canonical: 'https://boise-estate-cleanout.com/services/probate-services/probate-property-clearing' },
}

export default function ProbatePropertyClearingPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Probate Property Clearing</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides probate property clearing services with compassion, professionalism, and respect. We understand this is more than just clearing out a space—it's about handling memories, making tough decisions, and moving forward during a difficult time.</p>
            </div>
