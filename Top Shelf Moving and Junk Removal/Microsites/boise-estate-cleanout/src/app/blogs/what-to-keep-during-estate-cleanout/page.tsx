...
export const metadata: Metadata = {
  ...
  description: 'Making decisions about a loved one\'s belongings is hard. Here\'s a framework that helps.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/home-cleanout.webp"
          alt="What to Keep, Donate, and Toss During an Estate Cleanout"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            What to Keep, Donate, and Toss During an Estate Cleanout
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding What To Keep During Estate Cleanout</h2>
