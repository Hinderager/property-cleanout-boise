...
export const metadata: Metadata = {
  title: 'The Emotional Side of Estate Cleanouts (And How to Cope) | Estate Cleanout Pros',
  description: 'Clearing a home isn\'t just physical work. Here\'s how to handle the emotional weight.',
  alternates: {
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="The Emotional Side of Estate Cleanouts (And How to Cope)"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            The Emotional Side of Estate Cleanouts (And How to Cope)
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Emotional Side Of Estate Cleanouts</h2>
