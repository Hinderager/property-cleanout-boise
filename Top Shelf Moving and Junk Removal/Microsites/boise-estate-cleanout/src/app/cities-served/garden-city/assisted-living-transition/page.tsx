...
export const metadata: Metadata = {
  title: 'Assisted Living Transitions Garden City Idaho | Top Shelf Estate Cleanout',
  description: 'Help moving to assisted living in Garden City, Idaho. Fast, compassionate service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/garden-city/assisted-living-transition',
  },
}

export default function GardenCityAssistedLivingTransitionsPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Assisted Living Transitions in Garden City</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Help moving to assisted living for Garden City families.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides assisted living transitions services throughout Garden City and the Treasure Valley. We understand these situations require sensitivity, professionalism, and fast response times.</p>
