...
export const metadata: Metadata = {
  title: 'Probate Property Cleanout Middleton Idaho | Top Shelf Estate Cleanout',
  description: 'Fast cleanouts for probate properties in Middleton, Idaho. Fast, compassionate service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/middleton/probate-cleanout',
  },
}

export default function MiddletonProbatePropertyCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Probate Property Cleanout in Middleton</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Fast cleanouts for probate properties for Middleton families.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides probate property cleanout services throughout Middleton and the Treasure Valley. We understand these situations require sensitivity, professionalism, and fast response times.</p>
