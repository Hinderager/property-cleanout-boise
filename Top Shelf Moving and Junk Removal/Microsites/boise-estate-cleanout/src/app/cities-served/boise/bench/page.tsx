...
export const metadata: Metadata = {
  title: 'Estate Cleanout The Bench Boise | Top Shelf',
  description: 'Estate Cleanout services in The Bench, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['estate cleanout The Bench', 'estate cleanout The Bench Boise', 'The Bench boise estate cleanout'],
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/bench',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Estate Cleanout in The Bench
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need estate cleanout services in the The Bench area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Estate Cleanout in The Bench, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Estate cleanouts on the Bench often involve homes where families have lived for decades. We help sort through a lifetime of belongings, coordinating with estate sales companies when needed and ensuring usable items find new homes.</p>
                <p>
