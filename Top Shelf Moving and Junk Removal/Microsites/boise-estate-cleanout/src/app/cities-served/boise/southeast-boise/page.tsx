...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/southeast-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Estate Cleanout in Southeast Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Southeast Boise residents trust us for estate cleanout. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Estate Cleanout in Southeast Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Southeast Boise estate cleanouts range from modest homes to larger properties along the river. We tailor our approach to each situation, working with families to handle belongings appropriately.</p>
                <p>
