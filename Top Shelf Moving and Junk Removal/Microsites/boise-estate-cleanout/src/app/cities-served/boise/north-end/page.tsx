...
export const metadata: Metadata = {
  title: 'Estate Cleanout North End Boise | Top Shelf',
  description: 'Estate Cleanout services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['estate cleanout North End', 'estate cleanout North End Boise', 'North End boise estate cleanout'],
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Estate Cleanout in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Need estate cleanout services in the North End area? We can help.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Estate Cleanout in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Estate cleanouts in the North End often involve homes that have been in families for generations. We take extra care with these properties, understanding that every item might have historical or sentimental significance. We work at your pace to sort through belongings.</p>
                <p>
