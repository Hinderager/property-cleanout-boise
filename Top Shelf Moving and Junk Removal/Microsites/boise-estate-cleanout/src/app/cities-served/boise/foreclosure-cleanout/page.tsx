...
export const metadata: Metadata = {
  title: 'Foreclosure Cleanout Boise Idaho | Top Shelf Estate Cleanout',
  description: 'Property cleanouts for foreclosures in Boise, Idaho. Fast, compassionate service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/foreclosure-cleanout',
  },
}
    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Foreclosure Cleanout in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Property cleanouts for foreclosures for Boise families.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides foreclosure cleanout services throughout Boise and the Treasure Valley. We understand these situations require sensitivity, professionalism, and fast response times.</p>
