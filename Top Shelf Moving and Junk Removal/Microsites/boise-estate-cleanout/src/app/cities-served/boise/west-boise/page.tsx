...
export const metadata: Metadata = {
  title: 'Estate Cleanout West Boise Boise | Top Shelf',
  description: 'Estate Cleanout services in West Boise, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['estate cleanout West Boise', 'estate cleanout West Boise Boise', 'West Boise boise estate cleanout'],
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/west-boise',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Estate Cleanout in West Boise
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving West Boise with professional estate cleanout services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Estate Cleanout in West Boise, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Estate cleanouts in West Boise cover everything from apartments to large family homes. We handle each situation with care, coordinating with families and estate representatives.</p>
                <p>
