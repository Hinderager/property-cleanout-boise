...
export const metadata: Metadata = {
  title: 'Senior Downsizing Help Boise Idaho | Top Shelf Estate Cleanout',
  description: 'Compassionate downsizing assistance in Boise, Idaho. Fast, compassionate service. Call (208) 505-9352 for a free quote.',
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/boise/senior-downsizing',
  },
}

export default function BoiseSeniorDownsizingHelpPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Senior Downsizing Help in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Compassionate downsizing assistance for Boise families.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides senior downsizing help services throughout Boise and the Treasure Valley. We understand these situations require sensitivity, professionalism, and fast response times.</p>
