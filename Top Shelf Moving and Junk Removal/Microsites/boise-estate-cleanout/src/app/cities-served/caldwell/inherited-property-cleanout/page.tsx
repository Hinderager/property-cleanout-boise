...
export const metadata: Metadata = {
  title: 'Inherited Property Cleanout Caldwell Idaho | Top Shelf Estate Cleanout',
  description: 'Clear out inherited properties in Caldwell, Idaho. Fast, compassionate service. Call (208) 943-5231 for a free quote.',
  alternates: {
    canonical: 'https://boise-estate-cleanout.com/cities-served/caldwell/inherited-property-cleanout',
  },
}

export default function CaldwellInheritedPropertyCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Inherited Property Cleanout in Caldwell</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Clear out inherited properties for Caldwell families.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout provides inherited property cleanout services throughout Caldwell and the Treasure Valley. We understand these situations require sensitivity, professionalism, and fast response times.</p>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-gray-50 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-600 text-sm">Same-day and next-day service available in Caldwell</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-lg text-center">
            ...
            <div className="bg-dark-blue p-8 rounded-xl text-center">
              <h2 className="text-2xl font-bold text-white mb-4">Serving Caldwell Families</h2>
            ...
            <div className="mt-12 text-center">
              <Link href="/cities-served/caldwell" className="text-dark-blue underline hover:text-[#0b7fb6]">
                ← Back to Caldwell Services
              </Link>
            </div>
          </div>
        </div>
