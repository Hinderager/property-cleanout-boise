          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-dark-blue p-8 rounded-xl text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:2089435231" className="inline-flex items-center justify-center gap-2 bg-[#FFC845] text-dark-blue px-8 py-3 rounded-lg font-bold text-lg hover:bg-yellow-400 transition-colors">
