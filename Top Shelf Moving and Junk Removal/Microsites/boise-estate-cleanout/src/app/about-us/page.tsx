    ...
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About Top Shelf Estate Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto">Your trusted partner during difficult times in the Treasure Valley.</p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Top Shelf Estate Cleanout is a locally owned and operated estate services company serving families throughout the Treasure Valley. We understand that estate cleanouts often happen during some of life's most challenging moments—after the loss of a loved one, during downsizing, or when helping aging parents transition to assisted living.</p>
              <p>That's why we approach every job with compassion, respect, and professionalism. Our team handles your family's belongings with care, treating each item as if it were our own. We're not just here to clear out a property—we're here to help you through this transition with as little stress as possible.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">We understand the emotional challenges you're facing.</p>
              </div>
              <div className="text-center">
                <Users className="w-12 h-12 text-[#FFC845] mx-auto mb-4" />
                <h3 className="text-xl font-bold text-dark-blue mb-2">Local Team</h3>
                <p className="text-gray-600">Treasure Valley residents helping our neighbors.</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/about-us/testimonials" className="bg-gray-50 p-4 rounded-lg hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-600">See what families say about our service</p>
              </Link>
