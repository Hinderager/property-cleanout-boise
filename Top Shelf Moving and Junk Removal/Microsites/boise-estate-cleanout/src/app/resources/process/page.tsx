            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Call us at (208) 943-5231. We'll ask a few basic questions about the property and your situation. This helps us understand what you need and give you a ballpark idea of timing and cost.</p>
                </div>
              </div>
