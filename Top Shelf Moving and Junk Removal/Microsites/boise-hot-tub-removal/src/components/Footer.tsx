        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/removal-process" className="text-white/80 hover:text-white transition-colors">
                  Removal Process
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/disposal-options" className="text-white/80 hover:text-white transition-colors">
                  Disposal Options
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Hot Tub Removal</li>
              <li className="text-white/80">Spa Disposal</li>
              <li className="text-white/80">Hot Tub Demolition</li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a
                    href="mailto:info@boise-hot-tub-removal.com"
                    className="text-white/80 hover:text-white transition-colors"
                  >
                    info@boise-hot-tub-removal.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
