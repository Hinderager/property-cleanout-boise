...
import { Droplets, Hammer, Truck, Recycle } from 'lucide-react'
...
const services = [
  {
    ...
    description: 'We remove hot tubs and spas of all sizes—acrylic, wood, inflatable, or fiberglass. We handle the entire job from start to finish.',
  },
  {
    icon: Hammer,
    title: 'Hot Tub Demolition',
    description: 'Some hot tubs need to be broken down onsite. We safely demolish and haul away every piece, leaving your yard clean.',
  },
  {
    icon: Truck,
    title: 'Same Day Service',
    description: 'Need that old spa gone fast? We offer same-day and next-day hot tub removal when you need it quick.',
  },
  {
    icon: Recycle,
    title: 'Eco-Friendly Disposal',
    description: 'We recycle what we can—plastics, metals, and other materials. Only true waste goes to the landfill.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional hot tub and spa removal services for the Treasure Valley
          </p>
        </div>
