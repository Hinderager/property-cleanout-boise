...
import { Droplets, Phone, Clock, Recycle } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gradient-to-br from-brand-dark via-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-8">
          Professional hot tub and spa removal with safe disconnection
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            ...
            <p className="text-slate-400 text-sm">Quick scheduling available</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Droplets className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Full Disconnection</h3>
            <p className="text-slate-400 text-sm">Safe electrical & plumbing</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Recycle className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Eco-Friendly</h3>
            <p className="text-slate-400 text-sm">Responsible disposal</p>
          </div>
        </div>
