...
export const metadata: Metadata = {
  ...
  description: 'A few steps before removal day makes everything go smoother. Here\'s your checklist.',
  alternates: {
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/above-ground-spa.webp"
          alt="How to Prepare Your Hot Tub for Removal"
          fill
          priority
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Preparing Hot Tub For Removal</h2>
