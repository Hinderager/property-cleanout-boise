...
export const metadata: Metadata = {
  ...
  description: 'Professional spa removal in Boise and the Treasure Valley. We remove all types of spas, swim spas, and jacuzzis. Fast service. Call (208) 505-9352.',
