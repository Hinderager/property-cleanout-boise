...
export const metadata: Metadata = {
  title: 'Pricing Information | Boise Hot Tub Removal',
  description: 'Pricing Information - Helpful information from Boise Hot Tub Removal. Call (208) 505-9352.',
  alternates: { canonical: 'https://boise-hot-tub-removal.com/resources/pricing' },
}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto prose prose-lg">
            <p>Content for Pricing Information coming soon.</p>
          </div>
        </div>
      </section>
