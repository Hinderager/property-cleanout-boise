...
export const metadata: Metadata = {
  title: 'Hot Tub Deck Removal Mountain Home ID | Boise Hot Tub Removal',
  description: 'Removal of hot tub decking and surrounds in Mountain Home, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
  keywords: ['hot tub deck removal Mountain Home', 'hot tub removal Mountain Home'],
  alternates: {
    canonical: 'https://boise-hot-tub-removal.com/cities-served/mountain-home/hot-tub-deck-removal',
  },
}
...
export default function MountainHomeHotTubDeckRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/hot-tub-removal-process.webp"
          alt="Hot Tub Deck Removal in Mountain Home, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Hot Tub Deck Removal in Mountain Home</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Removal of hot tub decking and surrounds in Mountain Home. Professional, efficient, and hassle-free.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#0B2F3A] mb-6">Hot Tub Deck Removal Services in Mountain Home</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need hot tub deck removal in Mountain Home? We've got you covered. Whether your hot tub is ancient, broken, or you just want it gone, we'll handle the whole process.</p>
            ...
            <div className="mt-12 p-8 bg-[#0B2F3A] rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Hot Tub Deck Removal in Mountain Home?</h3>
