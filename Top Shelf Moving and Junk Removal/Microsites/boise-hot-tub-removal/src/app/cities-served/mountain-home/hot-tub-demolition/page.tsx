...
export const metadata: Metadata = {
  ...
  description: 'Complete demolition and debris removal in Mountain Home, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
