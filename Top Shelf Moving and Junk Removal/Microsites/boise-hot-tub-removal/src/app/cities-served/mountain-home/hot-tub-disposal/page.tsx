...
export const metadata: Metadata = {
  ...
  description: 'Eco-friendly disposal and recycling services in Mountain Home, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 505-9352.',
