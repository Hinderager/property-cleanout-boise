...
export const metadata: Metadata = {
  title: 'Swim Spa Removal Eagle ID | Boise Hot Tub Removal',
  description: 'Removal of swim spas and exercise pools in Eagle, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
  keywords: ['swim spa removal Eagle', 'hot tub removal Eagle'],
  alternates: {
    canonical: 'https://boise-hot-tub-removal.com/cities-served/eagle/swim-spa-removal',
  },
}
...
export default function EagleSwimSpaRemovalPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/hot-tub-removal-process.webp"
          alt="Swim Spa Removal in Eagle, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Swim Spa Removal in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Removal of swim spas and exercise pools in Eagle. Professional, efficient, and hassle-free.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#0B2F3A] mb-6">Swim Spa Removal Services in Eagle</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need swim spa removal in Eagle? We've got you covered. Whether your hot tub is ancient, broken, or you just want it gone, we'll handle the whole process.</p>
            ...
            <div className="mt-12 p-8 bg-[#0B2F3A] rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Swim Spa Removal in Eagle?</h3>
