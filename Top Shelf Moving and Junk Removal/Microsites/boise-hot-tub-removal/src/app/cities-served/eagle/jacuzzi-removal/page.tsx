...
export const metadata: Metadata = {
  ...
  description: 'Removal of jacuzzi tubs and whirlpool baths in Eagle, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 505-9352.',
