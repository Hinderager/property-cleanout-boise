...
export const metadata: Metadata = {
  ...
  description: 'Removal of in-ground and built-in spa systems in Eagle, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 505-9352.',
