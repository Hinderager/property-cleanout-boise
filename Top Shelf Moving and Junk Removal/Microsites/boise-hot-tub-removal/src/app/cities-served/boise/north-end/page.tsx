...
export const metadata: Metadata = {
  title: 'Hot Tub Removal North End Boise | Top Shelf',
  description: 'Hot Tub Removal services in North End, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hot tub removal North End', 'hot tub removal North End Boise', 'North End boise hot tub removal'],
  alternates: {
    canonical: 'https://boise-hot-tub-removal.com/cities-served/boise/north-end',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hot Tub Removal in North End
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            North End residents trust us for hot tub removal. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Hot Tub Removal in North End, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Hot tub removal in the North End requires careful navigation around mature landscaping and older decks. We disassemble and haul away hot tubs and spas from even the trickiest backyard locations.</p>
                <p>
