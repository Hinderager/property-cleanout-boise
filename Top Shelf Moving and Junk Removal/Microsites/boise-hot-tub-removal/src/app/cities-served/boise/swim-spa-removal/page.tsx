...
export const metadata: Metadata = {
  ...
  description: 'Removal of swim spas and exercise pools in Boise, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 505-9352.',
