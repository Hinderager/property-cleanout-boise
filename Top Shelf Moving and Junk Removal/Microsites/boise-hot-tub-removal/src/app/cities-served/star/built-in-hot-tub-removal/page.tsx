...
export const metadata: Metadata = {
  ...
  description: 'Removal of in-ground and built-in spa systems in Star, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
