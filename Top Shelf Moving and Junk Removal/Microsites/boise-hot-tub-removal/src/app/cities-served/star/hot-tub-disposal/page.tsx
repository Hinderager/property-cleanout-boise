...
export const metadata: Metadata = {
  ...
  description: 'Eco-friendly disposal and recycling services in Star, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
