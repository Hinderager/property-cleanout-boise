...
export const metadata: Metadata = {
  ...
  description: 'Removal of hot tub decking and surrounds in Star, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 505-9352.',
