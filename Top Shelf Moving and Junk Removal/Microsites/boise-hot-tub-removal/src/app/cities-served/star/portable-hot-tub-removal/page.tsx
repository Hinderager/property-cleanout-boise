...
export const metadata: Metadata = {
  ...
  description: 'Removal of portable and above-ground hot tubs in Star, Idaho. Fast, reliable service. Licensed & insured. Same-day appointments available. Call (208) 943-5231.',
