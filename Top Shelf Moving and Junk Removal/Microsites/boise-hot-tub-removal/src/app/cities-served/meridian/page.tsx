...
export const metadata: Metadata = {
  title: 'Hot Tub Removal Meridian Idaho | Spa Removal | Boise Hot Tub Removal',
  description: 'Professional hot tub removal in Meridian, Idaho. Fast, affordable spa disposal and removal. Licensed & insured. Same-day service. Call (208) 943-5231.',
  keywords: ['hot tub removal Meridian', 'spa removal Meridian Idaho', 'jacuzzi removal Meridian'],
  alternates: {
    canonical: 'https://boise-hot-tub-removal.com/cities-served/meridian',
  },
}

const neighborhoods = ["Paramount","Lochsa Falls","Tuscany","Victory Village","Meridian Ranch","Discovery Park","South Meridian"]

const services = [
  { name: 'Portable Hot Tub Removal', href: '/cities-served/meridian/portable-hot-tub-removal', description: 'Above-ground spa removal' },
  { name: 'Built-In Hot Tub Removal', href: '/cities-served/meridian/built-in-hot-tub-removal', description: 'In-ground spa removal' },
  { name: 'Swim Spa Removal', href: '/cities-served/meridian/swim-spa-removal', description: 'Exercise spa removal' },
  { name: 'Jacuzzi Removal', href: '/cities-served/meridian/jacuzzi-removal', description: 'Whirlpool tub removal' },
  { name: 'Hot Tub Disposal', href: '/cities-served/meridian/hot-tub-disposal', description: 'Eco-friendly disposal' },
  { name: 'Hot Tub Demolition', href: '/cities-served/meridian/hot-tub-demolition', description: 'Complete demolition' },
  { name: 'Above Ground Pool Removal', href: '/cities-served/meridian/above-ground-pool-removal', description: 'Pool removal service' },
  { name: 'Hot Tub Deck Removal', href: '/cities-served/meridian/hot-tub-deck-removal', description: 'Deck & surround removal' },
]
    ...
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          ...
          alt="Hot Tub Removal in Meridian, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Hot Tub Removal in Meridian</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional hot tub removal services for Meridian homes and businesses. Licensed, insured, and ready to help.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#0B2F3A] mb-6">Meridian Hot Tub Removal Services</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Got an old hot tub taking up space in your Meridian backyard? Whether it's broken, unused, or you're just ready for a change, we'll get it out of there fast.</p>
              <p>We handle everything—disconnecting power and plumbing, breaking it down if needed, hauling it away, and leaving your yard clean. No guesswork, no hassle. Just straightforward hot tub removal in Meridian.</p>
            </div>

            <h3 className="text-2xl font-bold text-[#0B2F3A] mb-6">Our Services in Meridian</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0B2F3A] mb-6">Meridian Areas We Serve</h3>
            ...
            <h3 className="text-2xl font-bold text-[#0B2F3A] mb-6">Why Meridian Homeowners Choose Us</h3>
            ...
            <div className="mt-12 p-8 bg-[#0B2F3A] rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Hot Tub Removal in Meridian?</h3>
