...
export const metadata: Metadata = {
  title: 'Hot Tub Removal Lochsa Falls Meridian | Top Shelf',
  description: 'Hot Tub Removal services in Lochsa Falls, Meridian, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['hot tub removal Lochsa Falls', 'hot tub removal Lochsa Falls Meridian', 'Lochsa Falls meridian hot tub removal'],
  alternates: {
    canonical: 'https://boise-hot-tub-removal.com/cities-served/meridian/lochsa-falls',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Hot Tub Removal in Lochsa Falls
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Looking for hot tub removal in Lochsa Falls? You've found the right team.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Hot Tub Removal in Lochsa Falls, Meridian
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Hot tub removal in Lochsa Falls with care for surrounding landscaping. We leave your yard clean.</p>
                <p>
      ...
      <section className="py-8 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            Back to Meridian Hot Tub Removal
          </Link>
        </div>
      </section>
    </main>
