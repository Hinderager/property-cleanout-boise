        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/moving-tips" className="text-white/80 hover:text-white transition-colors">
                  Moving Tips
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/packing-guide" className="text-white/80 hover:text-white transition-colors">
                  Packing Guide
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-white/80">Local Moving</li>
              <li className="text-white/80">Apartment Moving</li>
              <li className="text-white/80">House Moving</li>
              <li className="text-white/80">Loading/Unloading</li>
              <li className="text-white/80">Packing Services</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <a
                    href="mailto:info@boise-movers.com"
                    className="text-white/80 hover:text-white transition-colors"
                  >
                    info@boise-movers.com
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              <p className="text-white/60 text-sm">
                &copy; {new Date().getFullYear()} Boise Moving Pros. All rights reserved.
              </p>
