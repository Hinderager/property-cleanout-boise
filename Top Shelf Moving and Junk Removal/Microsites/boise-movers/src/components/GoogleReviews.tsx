...
// Static reviews for moving services
const staticReviews = [
  {
    author: 'Sarah M.',
    relative_time: '2 weeks ago',
    rating: 5,
    text: 'Best movers in Boise! They moved our 3-bedroom house in under 6 hours. Everything was wrapped carefully, nothing was damaged. The guys were friendly and professional. Will definitely use again for our next move.',
  },
  {
    author: 'David R.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'Moved from a 3rd floor apartment with no elevator and these guys handled it like pros. They were careful with the walls and my furniture. Fair price and showed up right on time. Highly recommend!',
  },
  {
    author: 'Jennifer K.',
    relative_time: '3 weeks ago',
    rating: 5,
    text: 'We needed help loading a rental truck and they were amazing. Worked quickly but carefully, fit everything perfectly. Saved my back and my sanity. Great value for the price.',
  },
  {
    author: 'Michael T.',
    relative_time: '2 weeks ago',
    rating: 5,
    text: 'Professional from start to finish. They wrapped all our furniture, protected the floors, and handled our antiques with extra care. Nothing was scratched or broken. Worth every penny.',
  },
  {
    author: 'Lisa H.',
    relative_time: '1 month ago',
    rating: 5,
    text: 'Used their packing services and local moving together. They packed our entire house in one day and moved us the next. So organized and efficient. Made moving stress-free!',
  },
  {
    author: 'Robert B.',
    relative_time: '3 months ago',
    rating: 5,
    text: 'Called for a last-minute move and they fit us in the next day. The crew was hardworking and respectful. They even helped arrange furniture in the new place. Great experience overall.',
  },
  {
    author: 'Amanda C.',
    relative_time: '2 months ago',
    rating: 5,
    text: 'Moved my elderly mother into her new condo. The movers were patient and kind with her, explained everything they were doing. They went above and beyond. So grateful!',
  },
  {
    author: 'James W.',
    relative_time: '1 week ago',
    rating: 5,
    text: 'Fourth time using these movers and they never disappoint. Consistent quality and pricing. They remember us and always send great crews. The best moving company in the Treasure Valley.',
  },
]
