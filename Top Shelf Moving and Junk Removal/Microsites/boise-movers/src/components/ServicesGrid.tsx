...
const services = [
  {
    icon: Truck,
    title: 'Local Moving',
    description: 'Full-service local moving within Boise and the Treasure Valley. We handle everything from loading to unloading.',
  },
  {
    icon: Building2,
    title: 'Apartment Moving',
    description: 'Specialized apartment moves with careful navigation of stairs, elevators, and tight spaces.',
  },
  {
    icon: Package,
    title: 'Packing Services',
    description: 'Professional packing with quality materials. We protect your belongings with care and attention to detail.',
  },
  {
    icon: Users,
    title: 'Loading/Unloading',
    description: 'Need help with just the heavy lifting? We offer labor-only services to load or unload your rental truck.',
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Professional moving services for the Treasure Valley
          </p>
        </div>
