...
export const metadata: Metadata = {
  title: 'How Much Do Movers Cost in Boise? | Moving Pros',
  description: 'Moving costs depend on several factors. Here\'s a realistic breakdown of what to expect.',
  alternates: {
    canonical: 'https://boise-movers.com/blogs/how-much-do-movers-cost-boise',
  },
}
  ...
  return (
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          src="/generated/long-distance-moving.webp"
          alt="How Much Do Movers Cost in Boise?"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            How Much Do Movers Cost in Boise?
          </h1>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-600 leading-relaxed">If you're looking for moving services in Boise and the Treasure Valley, you've probably got questions. Let's answer the most common ones.</p>
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding How Much Do Movers Cost Boise</h2>
            <p className="text-gray-600 leading-relaxed">When it comes to moving, there's a lot of conflicting information out there. Some websites make it sound complicated. Others oversimplify. Here's the real deal.</p>
            <p className="text-gray-600 leading-relaxed">First, let's establish what we're actually talking about. Moving in the Boise area involves professional handling of your project from start to finish. That means proper equipment, trained crews, and responsible disposal or handling of materials.</p>
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Why This Matters in the Treasure Valley</h2>
            <p className="text-gray-600 leading-relaxed">Boise, Meridian, Nampa, and the surrounding cities have grown rapidly. With that growth comes more demand for quality moving services. But not all providers are created equal.</p>
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">What to Look for in a Moving Service</h2>
            ...
            <p className="text-gray-600 leading-relaxed">If you need moving services in Boise, we're here to help. Give us a call at (208) 361-1982 for a free estimate. No pressure, no obligation - just honest answers to your questions.</p>
            ...
            <div className="mt-12 bg-gray-100 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Moving Pros is here to help with all your moving needs in the Treasure Valley.
              </p>
              <a
                href="tel:2083611982"
