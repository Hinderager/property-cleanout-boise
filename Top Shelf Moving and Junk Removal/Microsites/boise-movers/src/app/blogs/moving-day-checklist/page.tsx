...
export const metadata: Metadata = {
  title: 'Your Moving Day Checklist (Don\'t Forget These) | Moving Pros',
  description: 'Moving day is hectic. This checklist keeps you on track and stress-free.',
  alternates: {
    canonical: 'https://boise-movers.com/blogs/moving-day-checklist',
  },
}
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Your Moving Day Checklist (Don't Forget These)"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Your Moving Day Checklist (Don't Forget These)
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Moving Day Checklist</h2>
