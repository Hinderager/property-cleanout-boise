...
export const metadata: Metadata = {
  title: 'Moving to Boise? Here\'s What You Need to Know | Moving Pros',
  description: 'Relocating to the Treasure Valley is exciting. Here\'s practical info to help your move go smoothly.',
  alternates: {
    canonical: 'https://boise-movers.com/blogs/moving-to-boise-guide',
  },
}
    ...
    <main>
      ...
      <section className="relative h-[300px] md:h-[400px] flex items-end">
        <Image
          ...
          alt="Moving to Boise? Here's What You Need to Know"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">
            Moving to Boise? Here's What You Need to Know
          </h1>
        </div>
      </section>
      ...
      <article className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-bold text-gunmetal mt-8 mb-4">Understanding Moving To Boise Guide</h2>
