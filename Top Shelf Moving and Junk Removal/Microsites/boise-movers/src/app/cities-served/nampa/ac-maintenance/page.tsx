...
export const metadata: Metadata = {
  title: 'AC Maintenance Nampa ID | Boise HVAC Pros',
  description: 'Professional AC maintenance and tune-up services to keep your system running efficiently. in Nampa, Idaho. Licensed & insured. Call (208) 505-9352.',
  keywords: ['ac maintenance Nampa', 'ac service Nampa', 'HVAC Nampa Idaho'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/nampa/ac-maintenance',
  },
}



export default function NampaACMaintenancePage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/ac-maintenance.webp"
          alt="AC Maintenance in Nampa, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">AC Maintenance in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional AC maintenance and tune-up services to keep your system running efficiently. Serving Nampa and Canyon County.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">AC Maintenance Services in Nampa</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              ...
              <p>Boise HVAC Pros provides professional ac maintenance throughout Nampa and Canyon County. Our experienced technicians arrive promptly, diagnose accurately, and fix problems right the first time.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need AC Maintenance in Nampa?</h3>
