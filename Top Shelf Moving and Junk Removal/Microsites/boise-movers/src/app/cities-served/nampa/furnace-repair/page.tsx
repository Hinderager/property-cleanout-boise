...
export const metadata: Metadata = {
  title: 'Furnace Repair Nampa ID | Boise HVAC Pros',
  description: 'Expert furnace repair services for gas and electric furnaces. in Nampa, Idaho. 24/7 emergency service. Licensed & insured. Call (208) 505-9352.',
  keywords: ['furnace repair Nampa', 'furnace service Nampa', 'HVAC Nampa Idaho'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/nampa/furnace-repair',
  },
}
...
export default function NampaFurnaceRepairPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/furnace-repair.webp"
          alt="Furnace Repair in Nampa, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Furnace Repair in Nampa</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Expert furnace repair services for gas and electric furnaces. Serving Nampa and Canyon County.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Furnace Repair Services in Nampa</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Living in Nampa means warm summers and cold winters with occasional temperature extremes. When your furnace system needs repair, you need a local team you can trust.</p>
              <p>Boise HVAC Pros provides professional furnace repair throughout Nampa and Canyon County. Our experienced technicians arrive promptly, diagnose accurately, and fix problems right the first time.</p>
            </div>

            
            <h3 className="text-2xl font-bold text-dark-blue mb-6">Common Furnace Problems We Fix in Nampa</h3>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Furnace Repair in Nampa?</h3>
