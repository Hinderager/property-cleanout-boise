...
export const metadata: Metadata = {
  title: 'HVAC Maintenance Meridian ID | Boise HVAC Pros',
  description: 'Professional hvac maintenance services. in Meridian, Idaho. Licensed & insured. Call (208) 505-9352.',
  keywords: ['hvac maintenance Meridian', 'ac service Meridian', 'HVAC Meridian Idaho'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/meridian/hvac-maintenance',
  },
}



export default function MeridianHVACMaintenancePage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/hvac-maintenance.webp"
          alt="HVAC Maintenance in Meridian, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">HVAC Maintenance in Meridian</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional hvac maintenance services. Serving Meridian and Ada County.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">HVAC Maintenance Services in Meridian</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Living in Meridian means hot, dry summers and cold winters typical of the high desert climate. When your ac system needs service, you need a local team you can trust.</p>
              <p>Boise HVAC Pros provides professional hvac maintenance throughout Meridian and Ada County. Our experienced technicians arrive promptly, diagnose accurately, and fix problems right the first time.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need HVAC Maintenance in Meridian?</h3>
