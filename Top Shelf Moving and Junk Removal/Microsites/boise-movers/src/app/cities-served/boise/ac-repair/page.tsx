...
export const metadata: Metadata = {
  title: 'AC Repair Boise ID | Boise HVAC Pros',
  description: 'Fast, reliable air conditioning repair services. We fix all AC brands and models. in Boise, Idaho. 24/7 emergency service. Licensed & insured. Call (208) 505-9352.',
  keywords: ['ac repair Boise', 'ac service Boise', 'HVAC Boise Idaho'],
  alternates: {
    canonical: 'https://boise-movers.com/cities-served/boise/ac-repair',
  },
}
...
export default function BoiseACRepairPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/ac-repair.webp"
          alt="AC Repair in Boise, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">AC Repair in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Fast, reliable air conditioning repair services. We fix all AC brands and models. Serving Boise and Ada County.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">AC Repair Services in Boise</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Living in Boise means hot summers reaching 100°F and cold winters dropping below freezing. When your ac system needs repair, you need a local team you can trust.</p>
              <p>Boise HVAC Pros provides professional ac repair throughout Boise and Ada County. Our experienced technicians arrive promptly, diagnose accurately, and fix problems right the first time.</p>
            </div>

            
            <h3 className="text-2xl font-bold text-dark-blue mb-6">Common AC Problems We Fix in Boise</h3>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need AC Repair in Boise?</h3>
