...
export const metadata: Metadata = {
  title: 'Furnace Installation Boise ID | Boise HVAC Pros',
...
export default function BoiseFurnaceInstallationPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/furnace-installation.webp"
          alt="Furnace Installation in Boise, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Furnace Installation in Boise</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Professional furnace installation and replacement services. Serving Boise and Ada County.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Furnace Installation Services in Boise</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Living in Boise means hot summers reaching 100°F and cold winters dropping below freezing. When your furnace system needs service, you need a local team you can trust.</p>
              <p>Boise HVAC Pros provides professional furnace installation throughout Boise and Ada County. Our experienced technicians arrive promptly, diagnose accurately, and fix problems right the first time.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Furnace Installation in Boise?</h3>
