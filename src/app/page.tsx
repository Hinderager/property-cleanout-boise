...
import { Building, Phone, Key, Truck } from 'lucide-react'
    ...
    <main className="min-h-screen bg-gradient-to-br from-brand-dark via-slate-800 to-slate-900 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl md:text-2xl text-slate-300 mb-8">
          Complete property cleanout services for any situation
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Building className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Foreclosure Cleanouts</h3>
            <p className="text-slate-400 text-sm">Bank & REO properties</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Key className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Rental Turnovers</h3>
            <p className="text-slate-400 text-sm">Get units ready fast</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
            <Truck className="w-8 h-8 text-brand-orange mx-auto mb-3" />
            <h3 className="text-white font-semibold mb-1">Hoarding Cleanup</h3>
            <p className="text-slate-400 text-sm">Compassionate service</p>
          </div>
        </div>
