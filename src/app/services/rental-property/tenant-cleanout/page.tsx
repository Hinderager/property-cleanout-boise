...
export const metadata: Metadata = {
  title: 'Tenant Cleanout | Top Shelf Property Cleanout',
  description: 'Tenant Cleanout services in Boise and the Treasure Valley. Professional, fast, and affordable.',
  alternates: { canonical: 'https://property-cleanout-boise.com/services/rental-property/tenant-cleanout' },
}

export default function TenantCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="py-16 bg-gradient-to-b from-dark-blue to-[#1a5a9e]">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white">Tenant Cleanout</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mt-4">Professional tenant cleanout services throughout the Treasure Valley.</p>
        </div>
      </section>
      <VisibleBreadcrumb />
      <QuickQuoteBar />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-gray-600 mb-12">
              <p>Need a tenant cleanout? Top Shelf Property Cleanout provides fast, professional service throughout Boise and the Treasure Valley.</p>
            ...
            <div className="p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Tenant Cleanout?</h3>
