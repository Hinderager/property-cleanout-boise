...
export const metadata: Metadata = {
  ...
  description: 'Real estate property cleanout services in Boise. Pre-sale, inherited property, and bank-owned cleanouts. Professional service. Call (208) 505-9352.',
