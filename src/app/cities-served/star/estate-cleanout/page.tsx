...
export const metadata: Metadata = {
  title: 'Estate Cleanout Star ID | Top Shelf Property Cleanout',
  description: 'Compassionate estate cleanouts in Star, Idaho. Fast, professional service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['estate cleanout Star', 'property cleanout Star'],
  alternates: {
    canonical: 'https://property-cleanout-boise.com/cities-served/star/estate-cleanout',
  },
}
    ...
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          ...
          alt="Estate Cleanout in Star, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Estate Cleanout in Star</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Compassionate estate cleanouts. Serving Star and the Treasure Valley.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Dealing with a property cleanout situation in Star? We handle all types of estate cleanout projects throughout Star and the Treasure Valley.</p>
