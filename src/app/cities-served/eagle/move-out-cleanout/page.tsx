...
export const metadata: Metadata = {
  title: 'Move-Out Cleanout Eagle ID | Top Shelf Property Cleanout',
  description: 'Move-out and transition cleanouts in Eagle, Idaho. Fast, professional service. Licensed & insured. Call (208) 943-5231.',
  keywords: ['move out cleanout Eagle', 'property cleanout Eagle'],
  alternates: {
    canonical: 'https://property-cleanout-boise.com/cities-served/eagle/move-out-cleanout',
  },
}
...
export default function EagleMoveOutCleanoutPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/move-out-cleanout.webp"
          alt="Move-Out Cleanout in Eagle, Idaho"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Move-Out Cleanout in Eagle</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Move-out and transition cleanouts. Serving Eagle and the Treasure Valley.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Move-Out Cleanout Services in Eagle</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Dealing with a property cleanout situation in Eagle? We handle all types of move out cleanout projects throughout Eagle and the Treasure Valley.</p>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Move-Out Cleanout in Eagle?</h3>
