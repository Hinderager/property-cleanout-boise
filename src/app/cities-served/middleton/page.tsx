...
const neighborhoods = ["Downtown Middleton","Purple Sage","Scotch Pines","Longmont"]

const services = [
  { name: 'Rental Property Cleanout', href: '/cities-served/middleton/rental-property-cleanout', description: 'Complete rental cleanouts' },
  { name: 'Foreclosure Cleanout', href: '/cities-served/middleton/foreclosure-cleanout', description: 'REO property cleanouts' },
  { name: 'Eviction Cleanout', href: '/cities-served/middleton/eviction-cleanout', description: 'Post-eviction cleanup' },
  { name: 'Estate Cleanout', href: '/cities-served/middleton/estate-cleanout', description: 'Compassionate estate services' },
  { name: 'Commercial Cleanout', href: '/cities-served/middleton/commercial-property-cleanout', description: 'Office & retail cleanouts' },
  { name: 'Move-Out Cleanout', href: '/cities-served/middleton/move-out-cleanout', description: 'Moving transition help' },
  { name: 'Real Estate Cleanout', href: '/cities-served/middleton/real-estate-cleanout', description: 'Pre-sale cleanouts' },
  { name: 'Junk Removal', href: '/cities-served/middleton/junk-removal', description: 'General junk removal' },
]
  ...
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/middleton-cleanout.webp"
          alt="Property Cleanout Services in Middleton, Idaho"
          fill
          priority
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Middleton Property Cleanout Services</h2>
            <div className="prose prose-lg max-w-none text-gray-600 mb-8">
              <p>Need a property cleaned out in Middleton? We handle rentals, foreclosures, estates, and commercial properties throughout Middleton and the Treasure Valley.</p>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700"><strong>Local Service:</strong> We're based in the Treasure Valley and serve Middleton regularly.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
                <span className="text-gray-700"><strong>Same-Day Available:</strong> Often available same-day or next-day for Middleton properties.</span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-6 h-6 text-green-500 flex-shrink-0 mt-0.5" />
